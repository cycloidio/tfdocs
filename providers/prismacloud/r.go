...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage an account group.`,
			Description:      ``,
			Keywords: []string{
				"account",
				"group",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage an alert rule.`,
			Description:      ``,
			Keywords: []string{
				"alert",
				"rule",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage a cloud account on the Prisma Cloud platform.`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"account",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "role_arn",
					Description: `(Required) Unique identifier for an AWS resource (ARN). ### Azure`,
				},
				resource.Attribute{
					Name:        "account_id",
				...
				resource.Attribute{
					...
					Description: `(Required) Unique ID of the service principal object associated with the Prisma Cloud application that you create. ### GCP`,
				},
				resource.Attribute{
					Name:        "account_id",
				...
				resource.Attribute{
					...
					Description: `(Required) Content of the JSON credentials file (read in using ` + "`" + `file()` + "`" + `). ### Alibaba Cloud`,
				},
				resource.Attribute{
					Name:        "account_id",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage a compliance standard.`,
			Description:      ``,
			Keywords: []string{
				"compliance",
				"standard",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage a compliance standard requirement.`,
			Description:      ``,
			Keywords: []string{
				"compliance",
				"standard",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage a compliance standard requirement section.`,
			Description:      ``,
			Keywords: []string{
				"compliance",
				"standard",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manages enterprise settings config.`,
			Description:      ``,
			Keywords: []string{
				"enterprise",
				"settings",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manages an integration.`,
			Description:      ``,
			Keywords: []string{
				"integration",
			},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage a specific policy.`,
			Description:      ``,
			Keywords: []string{
				"policy",
			},
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "parameters",
					Description: `(Required, map of strings) Parameters`,
				},
				resource.Attribute{
					Name:        "rule_type",
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `Manage an user role.`,
			Description:      ``,
			Keywords: []string{
				"user",
				"role",
