...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "backup",
					Description: `(Optional) A bool that indicates whether the the member is backup.`,
				},
				resource.Attribute{
					Name:        "id",
	...
	resourcesMap = map[string]int{
		...
		"openstack_blockstorage_volume_type_access_v3":       4,
		"openstack_blockstorage_volume_type_v3":              5,
		"openstack_blockstorage_volume_v1":                   6,
		"openstack_blockstorage_volume_v2":                   7,
		"openstack_blockstorage_volume_v3":                   8,
		"openstack_compute_flavor_access_v2":                 9,
		"openstack_compute_flavor_v2":                        10,
		"openstack_compute_floatingip_associate_v2":          11,
		"openstack_compute_floatingip_v2":                    12,
		"openstack_compute_instance_v2":                      13,
		"openstack_compute_interface_attach_v2":              14,
		"openstack_compute_keypair_v2":                       15,
		"openstack_compute_quotaset_v2":                      16,
		"openstack_compute_secgroup_v2":                      17,
		"openstack_compute_servergroup_v2":                   18,
		"openstack_compute_volume_attach_v2":                 19,
		"openstack_containerinfra_cluster_v1":                20,
		"openstack_containerinfra_clustertemplate_v1":        21,
		"openstack_db_configuration_v1":                      22,
		"openstack_db_database_v1":                           23,
		"openstack_db_instance_v1":                           24,
		"openstack_db_user_v1":                               25,
		"openstack_dns_recordset_v2":                         26,
		"openstack_dns_transfer_accept_v2":                   27,
		"openstack_dns_transfer_request_v2":                  28,
		"openstack_dns_zone_v2":                              29,
		"openstack_fw_firewall_v1":                           30,
		"openstack_fw_policy_v1":                             31,
		"openstack_fw_rule_v1":                               32,
		"openstack_identity_application_credential_v3":       33,
		"openstack_identity_ec2_credential_v3":               34,
		"openstack_identity_endpoint_v3":                     35,
		"openstack_identity_group_v3":                        36,
		"openstack_identity_project_v3":                      37,
		"openstack_identity_role_assignment_v3":              38,
		"openstack_identity_role_v3":                         39,
		"openstack_identity_service_v3":                      40,
		"openstack_identity_user_membership_v3":              41,
		"openstack_identity_user_v3":                         42,
		"openstack_images_image_access_accept_v2":            43,
		"openstack_images_image_access_v2":                   44,
		"openstack_images_image_v2":                          45,
		"openstack_keymanager_container_v1":                  46,
		"openstack_keymanager_order_v1":                      47,
		"openstack_keymanager_secret_v1":                     48,
		"openstack_lb_l7policy_v2":                           49,
		"openstack_lb_l7rule_v2":                             50,
		"openstack_lb_listener_v2":                           51,
		"openstack_lb_loadbalancer_v2":                       52,
		"openstack_lb_member_v1":                             53,
		"openstack_lb_member_v2":                             54,
		"openstack_lb_members_v2":                            55,
		"openstack_lb_monitor_v1":                            56,
		"openstack_lb_monitor_v2":                            57,
		"openstack_lb_pool_v1":                               58,
		"openstack_lb_pool_v2":                               59,
		"openstack_lb_quota_v2":                              60,
		"openstack_lb_vip_v1":                                61,
		"openstack_networking_addressscope_v2":               62,
		"openstack_networking_floatingip_associate_v2":       63,
		"openstack_networking_floatingip_v2":                 64,
		"openstack_networking_network_v2":                    65,
		"openstack_networking_port_secgroup_associate_v2":    66,
		"openstack_networking_port_v2":                       67,
		"openstack_networking_qos_bandwidth_limit_rule_v2":   68,
		"openstack_networking_qos_dscp_marking_rule_v2":      69,
		"openstack_networking_qos_minimum_bandwidth_rule_v2": 70,
		"openstack_networking_qos_policy_v2":                 71,
		"openstack_networking_quota_v2":                      72,
		"openstack_networking_rbac_policy_v2":                73,
		"openstack_networking_router_interface_v2":           74,
		"openstack_networking_router_route_v2":               75,
		"openstack_networking_router_v2":                     76,
		"openstack_networking_secgroup_rule_v2":              77,
		"openstack_networking_secgroup_v2":                   78,
		"openstack_networking_subnet_route_v2":               79,
		"openstack_networking_subnet_v2":                     80,
		"openstack_networking_subnetpool_v2":                 81,
		"openstack_networking_trunk_v2":                      82,
		"openstack_objectstorage_container_v1":               83,
		"openstack_objectstorage_object_v1":                  84,
		"openstack_objectstorage_tempurl_v1":                 85,
		"openstack_orchestration_stack_v1":                   86,
		"openstack_sharedfilesystem_securityservice_v2":      87,
		"openstack_sharedfilesystem_share_access_v2":         88,
		"openstack_sharedfilesystem_share_v2":                89,
		"openstack_sharedfilesystem_sharenetwork_v2":         90,
		"openstack_vpnaas_endpoint_group_v2":                 91,
		"openstack_vpnaas_ike_policy_v2":                     92,
		"openstack_vpnaas_ipsec_policy_v2":                   93,
		"openstack_vpnaas_service_v2":                        94,
		"openstack_vpnaas_site_connection_v2":                95,
	}
)
