...
var (
	...
	resourcesMap = map[string]int{
		...
		"openstack_db_configuration_v1":                      24,
		"openstack_db_database_v1":                           25,
		"openstack_db_instance_v1":                           26,
		"openstack_db_user_v1":                               27,
		"openstack_dns_recordset_v2":                         28,
		"openstack_dns_transfer_accept_v2":                   29,
		"openstack_dns_transfer_request_v2":                  30,
		"openstack_dns_zone_v2":                              31,
		"openstack_fw_firewall_v1":                           32,
		"openstack_fw_policy_v1":                             33,
		"openstack_fw_rule_v1":                               34,
		"openstack_identity_application_credential_v3":       35,
		"openstack_identity_ec2_credential_v3":               36,
		"openstack_identity_endpoint_v3":                     37,
		"openstack_identity_group_v3":                        38,
		"openstack_identity_project_v3":                      39,
		"openstack_identity_role_assignment_v3":              40,
		"openstack_identity_role_v3":                         41,
		"openstack_identity_service_v3":                      42,
		"openstack_identity_user_membership_v3":              43,
		"openstack_identity_user_v3":                         44,
		"openstack_images_image_access_accept_v2":            45,
		"openstack_images_image_access_v2":                   46,
		"openstack_images_image_v2":                          47,
		"openstack_keymanager_container_v1":                  48,
		"openstack_keymanager_order_v1":                      49,
		"openstack_keymanager_secret_v1":                     50,
		"openstack_lb_l7policy_v2":                           51,
		"openstack_lb_l7rule_v2":                             52,
		"openstack_lb_listener_v2":                           53,
		"openstack_lb_loadbalancer_v2":                       54,
		"openstack_lb_member_v1":                             55,
		"openstack_lb_member_v2":                             56,
		"openstack_lb_members_v2":                            57,
		"openstack_lb_monitor_v1":                            58,
		"openstack_lb_monitor_v2":                            59,
		"openstack_lb_pool_v1":                               60,
		"openstack_lb_pool_v2":                               61,
		"openstack_lb_quota_v2":                              62,
		"openstack_lb_vip_v1":                                63,
		"openstack_networking_addressscope_v2":               64,
		"openstack_networking_floatingip_associate_v2":       65,
		"openstack_networking_floatingip_v2":                 66,
		"openstack_networking_network_v2":                    67,
		"openstack_networking_port_secgroup_associate_v2":    68,
		"openstack_networking_port_v2":                       69,
		"openstack_networking_qos_bandwidth_limit_rule_v2":   70,
		"openstack_networking_qos_dscp_marking_rule_v2":      71,
		"openstack_networking_qos_minimum_bandwidth_rule_v2": 72,
		"openstack_networking_qos_policy_v2":                 73,
		"openstack_networking_quota_v2":                      74,
		"openstack_networking_rbac_policy_v2":                75,
		"openstack_networking_router_interface_v2":           76,
		"openstack_networking_router_route_v2":               77,
		"openstack_networking_router_v2":                     78,
		"openstack_networking_secgroup_rule_v2":              79,
		"openstack_networking_secgroup_v2":                   80,
		"openstack_networking_subnet_route_v2":               81,
		"openstack_networking_subnet_v2":                     82,
		"openstack_networking_subnetpool_v2":                 83,
		"openstack_networking_trunk_v2":                      84,
		"openstack_objectstorage_container_v1":               85,
		"openstack_objectstorage_object_v1":                  86,
		"openstack_objectstorage_tempurl_v1":                 87,
		"openstack_orchestration_stack_v1":                   88,
		"openstack_sharedfilesystem_securityservice_v2":      89,
		"openstack_sharedfilesystem_share_access_v2":         90,
		"openstack_sharedfilesystem_share_v2":                91,
		"openstack_sharedfilesystem_sharenetwork_v2":         92,
		"openstack_vpnaas_endpoint_group_v2":                 93,
		"openstack_vpnaas_ike_policy_v2":                     94,
		"openstack_vpnaas_ipsec_policy_v2":                   95,
		"openstack_vpnaas_service_v2":                        96,
		"openstack_vpnaas_site_connection_v2":                97,
	}
)
