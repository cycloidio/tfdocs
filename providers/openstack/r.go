...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "protocol",
					Description: `(Required) The protocol - can either be TCP, HTTP, HTTPS, TERMINATED_HTTPS, UDP (supported only in Octavia) or SCTP (supported only in Octavia microversion >= 2.23). Changing this creates a new Listener.`,
				},
				resource.Attribute{
					Name:        "protocol_port",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "availability_zone",
					Description: `(Optional) The availability zone of the Loadbalancer. Changing this creates a new loadbalancer. Available only for Octavia microversion 2.14 or later.`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "backup",
					Description: `(Optional) A bool that indicates whether the the member is backup. Requires octavia microversion 2.1 or later. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "id",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "l7_policy",
					Description: `(Optional) Quota value for l7_policies. Changing this updates the existing quota. Omitting it sets it to 0. Available in Octavia 2.19.`,
				},
				resource.Attribute{
					Name:        "l7_rule",
					Description: `(Optional) Quota value for l7_rules. Changing this updates the existing quota. Omitting it sets it to 0. Available in Octavia 2.19. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "project_id",
					Description: `See Argument Reference above.`,
	...
	resourcesMap = map[string]int{
		...
		"openstack_dns_zone_v2":                              27,
		"openstack_fw_firewall_v1":                           28,
		"openstack_fw_policy_v1":                             29,
		"openstack_fw_rule_v1":                               30,
		"openstack_identity_application_credential_v3":       31,
		"openstack_identity_ec2_credential_v3":               32,
		"openstack_identity_endpoint_v3":                     33,
		"openstack_identity_group_v3":                        34,
		"openstack_identity_project_v3":                      35,
		"openstack_identity_role_assignment_v3":              36,
		"openstack_identity_role_v3":                         37,
		"openstack_identity_service_v3":                      38,
		"openstack_identity_user_membership_v3":              39,
		"openstack_identity_user_v3":                         40,
		"openstack_images_image_access_accept_v2":            41,
		"openstack_images_image_access_v2":                   42,
		"openstack_images_image_v2":                          43,
		"openstack_keymanager_container_v1":                  44,
		"openstack_keymanager_order_v1":                      45,
		"openstack_keymanager_secret_v1":                     46,
		"openstack_lb_l7policy_v2":                           47,
		"openstack_lb_l7rule_v2":                             48,
		"openstack_lb_listener_v2":                           49,
		"openstack_lb_loadbalancer_v2":                       50,
		"openstack_lb_member_v1":                             51,
		"openstack_lb_member_v2":                             52,
		"openstack_lb_members_v2":                            53,
		"openstack_lb_monitor_v1":                            54,
		"openstack_lb_monitor_v2":                            55,
		"openstack_lb_pool_v1":                               56,
		"openstack_lb_pool_v2":                               57,
		"openstack_lb_quota_v2":                              58,
		"openstack_lb_vip_v1":                                59,
		"openstack_networking_addressscope_v2":               60,
		"openstack_networking_floatingip_associate_v2":       61,
		"openstack_networking_floatingip_v2":                 62,
		"openstack_networking_network_v2":                    63,
		"openstack_networking_port_secgroup_associate_v2":    64,
		"openstack_networking_port_v2":                       65,
		"openstack_networking_qos_bandwidth_limit_rule_v2":   66,
		"openstack_networking_qos_dscp_marking_rule_v2":      67,
		"openstack_networking_qos_minimum_bandwidth_rule_v2": 68,
		"openstack_networking_qos_policy_v2":                 69,
		"openstack_networking_quota_v2":                      70,
		"openstack_networking_rbac_policy_v2":                71,
		"openstack_networking_router_interface_v2":           72,
		"openstack_networking_router_route_v2":               73,
		"openstack_networking_router_v2":                     74,
		"openstack_networking_secgroup_rule_v2":              75,
		"openstack_networking_secgroup_v2":                   76,
		"openstack_networking_subnet_route_v2":               77,
		"openstack_networking_subnet_v2":                     78,
		"openstack_networking_subnetpool_v2":                 79,
		"openstack_networking_trunk_v2":                      80,
		"openstack_objectstorage_container_v1":               81,
		"openstack_objectstorage_object_v1":                  82,
		"openstack_objectstorage_tempurl_v1":                 83,
		"openstack_orchestration_stack_v1":                   84,
		"openstack_sharedfilesystem_securityservice_v2":      85,
		"openstack_sharedfilesystem_share_access_v2":         86,
		"openstack_sharedfilesystem_share_v2":                87,
		"openstack_sharedfilesystem_sharenetwork_v2":         88,
		"openstack_vpnaas_endpoint_group_v2":                 89,
		"openstack_vpnaas_ike_policy_v2":                     90,
		"openstack_vpnaas_ipsec_policy_v2":                   91,
		"openstack_vpnaas_service_v2":                        92,
		"openstack_vpnaas_site_connection_v2":                93,
	}
)
