...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			ShortDescription: `Manages a V3 Qos association resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"block",
				"storage",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region in which to create the qos association. If omitted, the ` + "`" + `region` + "`" + ` argument of the provider is used. Changing this creates a new qos association.`,
				},
				resource.Attribute{
					Name:        "qos_id",
					Description: `(Required) ID of the qos to associate. Changing this creates a new qos association.`,
				},
				resource.Attribute{
					Name:        "volume_type_id",
					Description: `(Required) ID of the volume_type to associate. Changing this creates a new qos association. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
				...
				resource.Attribute{
					Name:        "volume_type_id",
					Description: `See Argument Reference above. ## Import Qos association can be imported using the ` + "`" + `qos_id/volume_type_id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_qos_association_v3.qos_association 941793f0-0a34-4bc4-b72e-a6326ae58283/ea257959-eeb1-4c10-8d33-26f0409a755d ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
		...
		&resource.Resource{
			...
			Category:         "Block Storage Resources",
			ShortDescription: `Manages a V3 Quality-Of-Servirce (qos) resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"block",
				"storage",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region in which to create the qos. If omitted, the ` + "`" + `region` + "`" + ` argument of the provider is used. Changing this creates a new qos.`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the qos. Changing this creates a new qos.`,
				},
				resource.Attribute{
					Name:        "consumer",
					Description: `(Optional) The consumer of qos. Can be one of ` + "`" + `front-end` + "`" + `, ` + "`" + `back-end` + "`" + ` or ` + "`" + `both` + "`" + `. Changing this updates the ` + "`" + `consumer` + "`" + ` of an existing qos.`,
				},
				resource.Attribute{
					Name:        "specs",
					Description: `(Optional) Key/Value pairs of specs for the qos. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "specs",
					Description: `See Argument Reference above. ## Import Qos can be imported using the ` + "`" + `qos_id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_qos_v3.qos 941793f0-0a34-4bc4-b72e-a6326ae58283 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "groups",
					Description: `(Optional) Quota value for groups. Changing this updates the existing quotaset.`,
				},
				resource.Attribute{
					Name:        "volume_type_quota",
					Description: `(Optional) Key/Value pairs for setting quota for volumes types. Possible keys are ` + "`" + `snapshots_<volume_type_name>` + "`" + `, ` + "`" + `volumes_<volume_type_name>` + "`" + ` and ` + "`" + `gigabytes_<volume_type_name>` + "`" + `. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "volume_type_quota",
					Description: `See Argument Reference above. ## Import Quotasets can be imported using the ` + "`" + `project_id/region` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_quotaset_v2.quotaset_1 2a0f2240-c5e6-41de-896d-e80d97428d6b/region_1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "volume_type_quota",
					Description: `See Argument Reference above. ## Import Quotasets can be imported using the ` + "`" + `project_id/region` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_quotaset_v3.quotaset_1 2a0f2240-c5e6-41de-896d-e80d97428d6b/region_1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_blockstorage_volume_type_access_v3",
			Category:         "Block Storage Resources",
			ShortDescription: `Manages a V3 volume type access resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"block",
				"storage",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "project_id",
					Description: `(Required) ID of the project to give access to. Changing this creates a new resource.`,
				},
				resource.Attribute{
					Name:        "volume_type_id",
					Description: `(Required) ID of the volume type to give access to. Changing this creates a new resource. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "volume_type_id",
					Description: `See Argument Reference above. ## Import Volume types access can be imported using the ` + "`" + `volume_type_id/project_id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_volume_type_access_v3.volume_type_access 941793f0-0a34-4bc4-b72e-a6326ae58283/ed498e81f0cc448bae0ad4f8f21bf67f ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "Block Storage Resources",
			ShortDescription: `Manages a V3 volume type resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"block",
				"storage",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the volume type. Changing this updates the ` + "`" + `name` + "`" + ` of an existing volume type.`,
				},
				resource.Attribute{
					Name:        "description",
					Description: `(Optional) Human-readable description of the port. Changing this updates the ` + "`" + `description` + "`" + ` of an existing volume type.`,
				},
				resource.Attribute{
					Name:        "is_public",
					Description: `(Optional) Whether the volume type is public. Changing this updates the ` + "`" + `is_public` + "`" + ` of an existing volume type.`,
				},
				resource.Attribute{
					Name:        "extra_specs",
					Description: `(Optional) Key/Value pairs of metadata for the volume type. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "extra_specs",
					Description: `See Argument Reference above. ## Import Volume types can be imported using the ` + "`" + `volume_type_id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_blockstorage_volume_type_v3.volume_type_1 941793f0-0a34-4bc4-b72e-a6326ae58283 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "flavor_id",
					Description: `(Optional) Unique ID (integer or UUID) of flavor to create. Changing this creates a new flavor.`,
				},
				resource.Attribute{
					Name:        "vcpus",
				...
				resource.Attribute{
					Name:        "disk",
					Description: `(Required) The amount of disk space in GiB to use for the root (/) partition. Changing this creates a new flavor.`,
				},
				resource.Attribute{
					Name:        "ephemeral",
					Description: `(Optional) The amount of ephemeral in GiB. If unspecified, the default is 0. Changing this creates a new flavor.`,
				},
				resource.Attribute{
					Name:        "swap",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "image_name",
					Description: `(Optional; Required if ` + "`" + `image_id` + "`" + ` is empty and not booting from a volume. Do not specify if booting from a volume.) The name of the desired image for the server. Changing this rebuilds the existing server.`,
				},
				resource.Attribute{
					Name:        "flavor_id",
				...
				resource.Attribute{
					Name:        "network_mode",
					Description: `(Optional) Special string for ` + "`" + `network` + "`" + ` option to create the server. ` + "`" + `network_mode` + "`" + ` can be ` + "`" + `"auto"` + "`" + ` or ` + "`" + `"none"` + "`" + `. Please see the following [reference](https://docs.openstack.org/api-ref/compute/?expanded=create-server-detail#id11) for more information. Conflicts with ` + "`" + `network` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "metadata",
				...
				resource.Attribute{
					Name:        "personality",
					Description: `(Optional) Customize the personality of an instance by defining one or more files and their contents. The personality structure is described below. Changing this rebuilds the existing server.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "different_cell",
					Description: `(Optional) The names of cells where not to build the instance.`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "user_id",
					Description: `(Optional) This allows administrative users to operate key-pairs of specified user ID. For this feature your need to have openstack microversion 2.10 (Liberty) or later.`,
				},
				resource.Attribute{
					Name:        "value_specs",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "server_group_members",
					Description: `See Argument Reference above. ## Import Quotasets can be imported using the ` + "`" + `project_id/region_name` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_compute_quotaset_v2.quotaset_1 2a0f2240-c5e6-41de-896d-e80d97428d6b/region_1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "multiattach",
					Description: `(Optional) Enable attachment of multiattach-capable volumes.`,
				},
				resource.Attribute{
					Name:        "vendor_options",
					Description: `(Optional) Map of additional vendor-specific options. Supported options are described below. The ` + "`" + `vendor_options` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "ignore_volume_confirmation",
					Description: `(Optional) Boolean to control whether to ignore volume status confirmation of the attached volume. This can be helpful to work with some OpenStack clouds which don't have the Block Storage V3 API available. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
		...
		&resource.Resource{
			...
			Category:         "Container Infra Resources",
			ShortDescription: `Manages a V1 Magnum node group resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"container",
				"infra",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `(Optional) Map of additional options. Changing this creates a new record set.`,
				},
				resource.Attribute{
					Name:        "disable_status_check",
					Description: `(Optional) Disable wait for recordset to reach ACTIVE status. This argumen is disabled by default. If it is set to true, the recordset will be considered as created/updated/deleted if OpenStack request returned success. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_dns_transfer_accept_v2",
			Category:         "DNS Resources",
			ShortDescription: `Manages a DNS zone Transfer accept in the OpenStack DNS Service`,
			Description:      ``,
			Keywords: []string{
				"dns",
				"transfer",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Required) The ID of the zone transfer request.`,
				},
				resource.Attribute{
					Name:        "key",
					Description: `(Required) The transfer key.`,
				},
				resource.Attribute{
					Name:        "value_specs",
					Description: `(Optional) Map of additional options. Changing this creates a new transfer accept.`,
				},
				resource.Attribute{
					Name:        "disable_status_check",
					Description: `(Optional) Disable wait for zone to reach ACTIVE status. The check is enabled by default. If this argument is true, zone will be considered as created/updated if OpenStack accept returned success. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `See Argument Reference above. ## Import This resource can be imported by specifying the transferAccept ID: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_dns_transfer_accept_v2.accept_1 <accept_id> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_dns_transfer_request_v2",
			Category:         "DNS Resources",
			ShortDescription: `Manages a DNS zone Transfer request in the OpenStack DNS Service`,
			Description:      ``,
			Keywords: []string{
				"dns",
				"transfer",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "zone_id",
					Description: `(Required) The ID of the zone for which to create the transfer request.`,
				},
				resource.Attribute{
					Name:        "target_project_id",
					Description: `(Optional) The target Project ID to transfer to.`,
				},
				resource.Attribute{
					Name:        "description",
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `(Optional) Map of additional options. Changing this creates a new transfer request.`,
				},
				resource.Attribute{
					Name:        "disable_status_check",
					Description: `(Optional) Disable wait for zone to reach ACTIVE status. The check is enabled by default. If this argument is true, zone will be considered as created/updated if OpenStack request returned success. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `See Argument Reference above. ## Import This resource can be imported by specifying the transferRequest ID: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_dns_transfer_request_v2.request_1 <request_id> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `(Optional) Map of additional options. Changing this creates a new zone.`,
				},
				resource.Attribute{
					Name:        "disable_status_check",
					Description: `(Optional) Disable wait for zone to reach ACTIVE status. The check is enabled by default. If this argument is true, zone will be considered as created/updated if OpenStack request returned success. ## Attributes Reference The following attributes are exported:`,
				...
				resource.Attribute{
					Name:        "value_specs",
					Description: `See Argument Reference above. ## Import This resource can be imported by specifying the zone ID with optional project ID: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_dns_zone_v2.zone_1 <zone_id> $ terraform import openstack_dns_zone_v2.zone_1 <zone_id>:<project_id> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_identity_ec2_credential_v3",
			Category:         "Identity Resources",
			ShortDescription: `Manages a V3 EC2 Credential resource within OpenStack Keystone.`,
			Description:      ``,
			Keywords: []string{
				"identity",
				"ec2",
			...
			Attributes: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "user_id",
					Description: `contains a User ID of the EC2 credential owner`,
				},
				resource.Attribute{
					Name:        "project_id",
					Description: `contains an EC2 credential project scope`,
				},
				resource.Attribute{
					Name:        "trust_id",
					Description: `contains an EC2 credential trust ID scope ## Import EC2 Credentials can be imported using the ` + "`" + `access` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_identity_ec2_credential_v3.ec2_cred_1 2d0ac4a2f81b4b0f9513ee49e780647d ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
		},
		&resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Identity Resources",
			ShortDescription: `Manages a V3 group resource within OpenStack Keystone.`,
			Description:      ``,
			Keywords: []string{
				"identity",
				"group",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region in which to obtain the V3 Keystone client. If omitted, the ` + "`" + `region` + "`" + ` argument of the provider is used. Changing this creates a new group. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above. ## Import groups can be imported using the ` + "`" + `id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_identity_group_v3.group_1 89c60255-9bd6-460c-822a-e2b959ede9d2 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "enabled",
					Description: `(Optional) Whether the project is enabled or disabled. Valid values are ` + "`" + `true` + "`" + ` and ` + "`" + `false` + "`" + `. Default is ` + "`" + `true` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "is_domain",
					Description: `(Optional) Whether this project is a domain. Valid values are ` + "`" + `true` + "`" + ` and ` + "`" + `false` + "`" + `. Default is ` + "`" + `false` + "`" + `. Changing this creates a new project/domain.`,
				},
				resource.Attribute{
					Name:        "name",
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_identity_user_membership_v3",
			Category:         "Identity Resources",
			ShortDescription: `Manages a user membership to group V3 resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"identity",
				"user",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region in which to obtain the V3 Identity client. If omitted, the ` + "`" + `region` + "`" + ` argument of the provider is used. Changing this creates a new user membership.`,
				},
				resource.Attribute{
					Name:        "user_id",
					Description: `(Required) The UUID of user to use. Changing this creates a new user membership.`,
				},
				resource.Attribute{
					Name:        "group_id",
					Description: `(Required) The UUID of group to which the user will be added. Changing this creates a new user membership. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "group_id",
					Description: `See Argument Reference above. ## Import This resource can be imported by specifying all two arguments, separated by a forward slash: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_identity_user_membership_v3.user_membership_1 <user_id>/<group_id> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "image_source_username",
					Description: `(Optional) The username of basic auth to download ` + "`" + `image_source_url` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "image_source_password",
					Description: `(Optional) The password of basic auth to download ` + "`" + `image_source_url` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "min_disk_gb",
				...
				resource.Attribute{
					Name:        "image_id",
					Description: `(Optional) Unique ID (valid UUID) of image to create. Changing this creates a new image.`,
				},
				resource.Attribute{
					Name:        "properties",
				...
				resource.Attribute{
					Name:        "hidden",
					Description: `(Optional) If true, image will be hidden from public list. Defaults to false.`,
				},
				resource.Attribute{
					Name:        "region",
				...
				resource.Attribute{
					Name:        "visibility",
					Description: `See Argument Reference above. ## Notes ### Properties This resource supports the ability to add properties to a resource during creation as well as add, update, and delete properties during an update of this resource. Newer versions of OpenStack are adding some read-only properties to each image. These properties start with the prefix ` + "`" + `os_` + "`" + `. If these properties are detected, this resource will automatically reconcile these with the user-provided properties. In addition, the ` + "`" + `direct_url` + "`" + ` and ` + "`" + `stores` + "`" + ` properties are also automatically reconciled if the Image Service set it. ## Import Images can be imported using the ` + "`" + `id` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_images_image_v2.rancheros 89c60255-9bd6-460c-822a-e2b959ede9d2 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "protocol",
					Description: `(Required) The protocol - can either be TCP, HTTP, HTTPS, TERMINATED_HTTPS, UDP (supported only in Octavia) or SCTP (supported only in`,
				},
				resource.Attribute{
					Name:        "protocol_port",
				...
				resource.Attribute{
					Name:        "insert_headers",
					Description: `(Optional) The list of key value pairs representing headers to insert into the request before it is sent to the backend members. Changing this updates the headers of the existing listener.`,
				},
				resource.Attribute{
					Name:        "allowed_cidrs",
					Description: `(Optional) A list of CIDR blocks that are permitted to connect to this listener, denying all other source addresses. If not present, defaults to allow all. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "id",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "vip_port_id",
					Description: `(Optional) The port UUID that the loadbalancer will use. Changing this creates a new loadbalancer. It is available only for Octavia.`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "availability_zone",
					Description: `(Optional) The availability zone of the Loadbalancer. Changing this creates a new loadbalancer. Available only for Octavia`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "tags",
					Description: `(Optional) A list of simple strings assigned to the loadbalancer. Available only for Octavia`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `See Argument Reference above.`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "admin_state_up",
					Description: `(Optional) The administrative state of the member. A valid value is true (UP) or false (DOWN). Defaults to true.`,
				},
				resource.Attribute{
					Name:        "monitor_address",
					Description: `(Optional) An alternate IP address used for health monitoring a backend member. Available only for Octavia`,
				},
				resource.Attribute{
					Name:        "monitor_port",
					Description: `(Optional) An alternate protocol port used for health monitoring a backend member. Available only for Octavia`,
				},
				resource.Attribute{
					Name:        "backup",
					Description: `(Optional) Boolean that indicates whether that member works as a backup or not. Available only for Octavia >= 2.1. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "id",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "monitor_port",
					Description: `(Optional) An alternate protocol port used for health monitoring a backend member.`,
				},
				resource.Attribute{
					Name:        "monitor_address",
					Description: `(Optional) An alternate IP address used for health monitoring a backend member.`,
				},
				resource.Attribute{
					Name:        "admin_state_up",
					Description: `(Optional) The administrative state of the member. A valid value is true (UP) or false (DOWN). Defaults to true.`,
				...
				resource.Attribute{
					Name:        "backup",
					Description: `(Optional) A bool that indicates whether the member is backup.`,
				},
				resource.Attribute{
					Name:        "id",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "protocol",
					Description: `(Required) The protocol - can either be TCP, HTTP, HTTPS, PROXY, UDP (supported only in Octavia), PROXYV2 (`,
				},
				resource.Attribute{
					Name:        "loadbalancer_id",
		...
		&resource.Resource{
			Name:             "",
			Type:             "openstack_lb_quota_v2",
			Category:         "Load Balancer Resources",
			ShortDescription: `Manages a V2 quota resource within OpenStack.`,
			Description:      ``,
			Keywords: []string{
				"load",
				"balancer",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "project_id",
					Description: `(Required) ID of the project to manage quotas. Changing this creates a new quota.`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) Region in which to manage quotas. Changing this creates a new quota. If ommited, the region of the credentials is used.`,
				},
				resource.Attribute{
					Name:        "loadbalancer",
					Description: `(Optional) Quota value for loadbalancers. Changing this updates the existing quota. Omitting it sets it to 0.`,
				},
				resource.Attribute{
					Name:        "listener",
					Description: `(Optional) Quota value for listeners. Changing this updates the existing quota. Omitting it sets it to 0.`,
				},
				resource.Attribute{
					Name:        "member",
					Description: `(Optional) Quota value for members. Changing this updates the existing quota. Omitting it sets it to 0.`,
				},
				resource.Attribute{
					Name:        "pool",
					Description: `(Optional) Quota value for pools. Changing this updates the the existing quota. Omitting it sets it to 0.`,
				},
				resource.Attribute{
					Name:        "health_monitor",
					Description: `(Optional) Quota value for health_monitors. Changing this updates the existing quota. Omitting it sets it to 0.`,
				},
				resource.Attribute{
					Name:        "l7_policy",
					Description: `(Optional) Quota value for l7_policies. Changing this updates the existing quota. Omitting it sets it to 0. Available in`,
				},
				resource.Attribute{
					Name:        "l7_rule",
					Description: `(Optional) Quota value for l7_rules. Changing this updates the existing quota. Omitting it sets it to 0. Available in`,
				},
				resource.Attribute{
					Name:        "project_id",
					Description: `See Argument Reference above.`,
				...
				resource.Attribute{
					Name:        "l7_rule",
					Description: `See Argument Reference above. ## Import Quotas can be imported using the ` + "`" + `project_id/region_name` + "`" + `, where region_name is the one defined is the Openstack credentials that are in use. E.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_lb_quota_v2.quota_1 2a0f2240-c5e6-41de-896d-e80d97428d6b/region_1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "subnet_ids",
					Description: `(Optional) A list of external subnet IDs to try over each to allocate a floating IP address. If a subnet ID in a list has exhausted floating IP pool, the next subnet ID will be tried. This argument is used only during the resource creation. Conflicts with a ` + "`" + `subnet_id` + "`" + ` argument.`,
				},
				resource.Attribute{
					Name:        "value_specs",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `The collection of Security Group IDs on the port which have been explicitly and implicitly added. ## Import Port security group association can be imported using the ` + "`" + `id` + "`" + ` of the port, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_networking_port_secgroup_associate_v2.port_1 eae26a3e-1c33-4cc1-9c31-0cd729c438a1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "subnetpool",
					Description: `See Argument Reference above. ## Import Quotas can be imported using the ` + "`" + `project_id/region_name` + "`" + `, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import openstack_networking_quota_v2.quota_1 2a0f2240-c5e6-41de-896d-e80d97428d6b/region_1 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "object_type",
					Description: `(Required) The type of the object that the RBAC policy affects. Can be one of the following: ` + "`" + `address_scope` + "`" + `, ` + "`" + `address_group` + "`" + `, ` + "`" + `network` + "`" + `, ` + "`" + `qos_policy` + "`" + `, ` + "`" + `security_group` + "`" + ` or ` + "`" + `subnetpool` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "target_tenant",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "storage_policy",
					Description: `(Optional) The storage policy to be used for the container. Changing this creates a new container.`,
				},
				resource.Attribute{
					Name:        "force_destroy",
	...
	resourcesMap = map[string]int{
		...
		"openstack_blockstorage_qos_association_v3":          0,
		"openstack_blockstorage_qos_v3":                      1,
		"openstack_blockstorage_quotaset_v2":                 2,
		"openstack_blockstorage_quotaset_v3":                 3,
		"openstack_blockstorage_volume_attach_v2":            4,
		"openstack_blockstorage_volume_attach_v3":            5,
		"openstack_blockstorage_volume_type_access_v3":       6,
		"openstack_blockstorage_volume_type_v3":              7,
		"openstack_blockstorage_volume_v1":                   8,
		"openstack_blockstorage_volume_v2":                   9,
		"openstack_blockstorage_volume_v3":                   10,
		"openstack_compute_flavor_access_v2":                 11,
		"openstack_compute_flavor_v2":                        12,
		"openstack_compute_floatingip_associate_v2":          13,
		"openstack_compute_floatingip_v2":                    14,
		"openstack_compute_instance_v2":                      15,
		"openstack_compute_interface_attach_v2":              16,
		"openstack_compute_keypair_v2":                       17,
		"openstack_compute_quotaset_v2":                      18,
		"openstack_compute_secgroup_v2":                      19,
		"openstack_compute_servergroup_v2":                   20,
		"openstack_compute_volume_attach_v2":                 21,
		"openstack_containerinfra_cluster_v1":                22,
		"openstack_containerinfra_clustertemplate_v1":        23,
		"openstack_containerinfra_nodegroup_v1":              24,
		"openstack_db_configuration_v1":                      25,
		"openstack_db_database_v1":                           26,
		"openstack_db_instance_v1":                           27,
		"openstack_db_user_v1":                               28,
		"openstack_dns_recordset_v2":                         29,
		"openstack_dns_transfer_accept_v2":                   30,
		"openstack_dns_transfer_request_v2":                  31,
		"openstack_dns_zone_v2":                              32,
		"openstack_fw_firewall_v1":                           33,
		"openstack_fw_policy_v1":                             34,
		"openstack_fw_rule_v1":                               35,
		"openstack_identity_application_credential_v3":       36,
		"openstack_identity_ec2_credential_v3":               37,
		"openstack_identity_endpoint_v3":                     38,
		"openstack_identity_group_v3":                        39,
		"openstack_identity_project_v3":                      40,
		"openstack_identity_role_assignment_v3":              41,
		"openstack_identity_role_v3":                         42,
		"openstack_identity_service_v3":                      43,
		"openstack_identity_user_membership_v3":              44,
		"openstack_identity_user_v3":                         45,
		"openstack_images_image_access_accept_v2":            46,
		"openstack_images_image_access_v2":                   47,
		"openstack_images_image_v2":                          48,
		"openstack_keymanager_container_v1":                  49,
		"openstack_keymanager_order_v1":                      50,
		"openstack_keymanager_secret_v1":                     51,
		"openstack_lb_l7policy_v2":                           52,
		"openstack_lb_l7rule_v2":                             53,
		"openstack_lb_listener_v2":                           54,
		"openstack_lb_loadbalancer_v2":                       55,
		"openstack_lb_member_v1":                             56,
		"openstack_lb_member_v2":                             57,
		"openstack_lb_members_v2":                            58,
		"openstack_lb_monitor_v1":                            59,
		"openstack_lb_monitor_v2":                            60,
		"openstack_lb_pool_v1":                               61,
		"openstack_lb_pool_v2":                               62,
		"openstack_lb_quota_v2":                              63,
		"openstack_lb_vip_v1":                                64,
		"openstack_networking_addressscope_v2":               65,
		"openstack_networking_floatingip_associate_v2":       66,
		"openstack_networking_floatingip_v2":                 67,
		"openstack_networking_network_v2":                    68,
		"openstack_networking_port_secgroup_associate_v2":    69,
		"openstack_networking_port_v2":                       70,
		"openstack_networking_qos_bandwidth_limit_rule_v2":   71,
		"openstack_networking_qos_dscp_marking_rule_v2":      72,
		"openstack_networking_qos_minimum_bandwidth_rule_v2": 73,
		"openstack_networking_qos_policy_v2":                 74,
		"openstack_networking_quota_v2":                      75,
		"openstack_networking_rbac_policy_v2":                76,
		"openstack_networking_router_interface_v2":           77,
		"openstack_networking_router_route_v2":               78,
		"openstack_networking_router_v2":                     79,
		"openstack_networking_secgroup_rule_v2":              80,
		"openstack_networking_secgroup_v2":                   81,
		"openstack_networking_subnet_route_v2":               82,
		"openstack_networking_subnet_v2":                     83,
		"openstack_networking_subnetpool_v2":                 84,
		"openstack_networking_trunk_v2":                      85,
		"openstack_objectstorage_container_v1":               86,
		"openstack_objectstorage_object_v1":                  87,
		"openstack_objectstorage_tempurl_v1":                 88,
		"openstack_orchestration_stack_v1":                   89,
		"openstack_sharedfilesystem_securityservice_v2":      90,
		"openstack_sharedfilesystem_share_access_v2":         91,
		"openstack_sharedfilesystem_share_v2":                92,
		"openstack_sharedfilesystem_sharenetwork_v2":         93,
		"openstack_vpnaas_endpoint_group_v2":                 94,
		"openstack_vpnaas_ike_policy_v2":                     95,
		"openstack_vpnaas_ipsec_policy_v2":                   96,
		"openstack_vpnaas_service_v2":                        97,
		"openstack_vpnaas_site_connection_v2":                98,
	}
)
