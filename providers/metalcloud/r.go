...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Type:             "drive_array",
			Category:         "Resources",
			ShortDescription: `Controls a Bigstep Metalcloud DriveArray.`,
			Description:      ``,
			Keywords: []string{
				"drive",
				"array",
		...
		&resource.Resource{
			...
			Type:             "instance_array",
			Category:         "Resources",
			ShortDescription: `Controls a Bigstep Metalcloud InstanceArray (collection of servers)`,
			Description:      ``,
			Keywords: []string{
				"instance",
				"array",
		...
		&resource.Resource{
			...
			Type:             "network",
			Category:         "Resources",
			ShortDescription: `Controls a Bigstep Metalcloud network.`,
			Description:      ``,
			Keywords: []string{
				"network",
			},
