	...
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "package",
					Description: `(Optional) A Wasm deployment package to upload. Defined below.`,
				},
				resource.Attribute{
					Name:        "force_destroy",
				...
				resource.Attribute{
					...
					Description: `(Optional) A Rackspace Cloud Files endpoint to send streaming logs to. Defined below. The ` + "`" + `domain` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "healthcheck",
					Description: `(Optional) Name of a defined ` + "`" + `healthcheck` + "`" + ` to assign to this backend. The ` + "`" + `healthcheck` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "window",
					Description: `(Optional) The number of most recent Healthcheck queries to keep for this Healthcheck. Default ` + "`" + `5` + "`" + `. The ` + "`" + `package` + "`" + ` block supports uploading or modifying Wasm packages for use in a Fastly Compute@Edge service. See Fastly's documentation on [Compute@Edge](https://www.fastly.com/products/edge-compute/serverless)`,
				},
				resource.Attribute{
					Name:        "filename",
					Description: `(Required) The path to the Wasm deployment package within your local filesystem.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "redundancy",
					Description: `(Optional) The S3 redundancy level. Should be formatted; one of: ` + "`" + `standard` + "`" + `, ` + "`" + `reduced_redundancy` + "`" + ` or null. Default ` + "`" + `null` + "`" + `. The ` + "`" + `papertrail` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "port",
					Description: `(Required) The port associated with the address where the Papertrail endpoint can be accessed. The ` + "`" + `sumologic` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted; one of: ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `classic` + "`" + `. See [Fastly's Documentation on Sumologic][fastly-sumologic] The ` + "`" + `gcslogging` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted; one of: ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `classic` + "`" + `. [Fastly Documentation](https://developer.fastly.com/reference/api/logging/gcs/) The ` + "`" + `bigquerylogging` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "secret_key",
					Description: `(Optional) The secret key associated with the sservice account that has write access to your BigQuery table. If not provided, this will be pulled from the ` + "`" + `FASTLY_BQ_SECRET_KEY` + "`" + ` environment variable. Typical format for this is a private key in a string with newlines. The ` + "`" + `syslog` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted; one of: ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `classic` + "`" + `. The ` + "`" + `logentries` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Required) A unique name to identify this GCS endpoint.`,
				...
				resource.Attribute{
					Name:        "use_tls",
					Description: `(Optional) Whether to use TLS for secure logging. Defaults to ` + "`" + `true` + "`" + ` The ` + "`" + `splunk` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted. Can be either ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `classic` + "`" + `. The ` + "`" + `httpslogging` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `How the message should be formatted; one of: ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `blank` + "`" + `. The ` + "`" + `logging_elasticsearch` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "tls_hostname",
					Description: `(Optional) The hostname used to verify the server's certificate. It can either be the Common Name (CN) or a Subject Alternative Name (SAN). The ` + "`" + `logging_ftp` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "timestamp_format",
					Description: `(Optional) specified timestamp formatting (default ` + "`" + `%Y-%m-%dT%H:%M:%S.000` + "`" + `). The ` + "`" + `logging_sftp` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region that log data will be sent to. One of ` + "`" + `US` + "`" + ` or ` + "`" + `EU` + "`" + `. Defaults to ` + "`" + `US` + "`" + ` if undefined. The ` + "`" + `logging_loggly` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "token",
					Description: `(Required) The token to use for authentication (https://www.loggly.com/docs/customer-token-authentication-token/). The ` + "`" + `logging_newrelic` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "token",
					Description: `(Required) The Insert API key from the Account page of your New Relic account. The ` + "`" + `logging_scalyr` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "region",
					Description: `(Optional) The region that log data will be sent to. One of US or EU. Defaults to US if undefined. The ` + "`" + `logging_googlepubsub` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "topic",
					Description: `(Required) The Google Cloud Pub/Sub topic to which logs will be published. The ` + "`" + `logging_kafka` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "tls_hostname",
					Description: `(Optional) The hostname used to verify the server's certificate. It can either be the Common Name or a Subject Alternative Name (SAN). The ` + "`" + `logging_heroku` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "url",
					Description: `(Required) The url to stream logs to. The ` + "`" + `logging_honeycomb` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "token",
					Description: `(Required) The Write Key from the Account page of your Honeycomb account. The ` + "`" + `logging_logshuttle` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "url",
					Description: `(Required) Your Log Shuttle endpoint url. The ` + "`" + `logging_openstack` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted; one of: ` + "`" + `classic` + "`" + `, ` + "`" + `loggly` + "`" + `, ` + "`" + `logplex` + "`" + ` or ` + "`" + `blank` + "`" + `. Default ` + "`" + `classic` + "`" + `. [Fastly Documentation](https://developer.fastly.com/reference/api/logging/gcs/) The ` + "`" + `logging_digitalocean` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "message_type",
					Description: `(Optional) How the message should be formatted. One of: classic (default), loggly, logplex or blank. The ` + "`" + `logging_cloudfiles` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "placement",
					Description: `(Optional) Where in the generated VCL the logging call should be placed. The ` + "`" + `logging_datadog` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Required) The unique name of the Datadog logging endpoint.`,
				...
				resource.Attribute{
					Name:        "response_condition",
					Description: `(Optional) The name of an existing condition in the configured endpoint, or leave blank to always execute. The ` + "`" + `response_object` + "`" + ` block supports:`,
				},
				resource.Attribute{
					Name:        "name",
