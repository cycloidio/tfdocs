...
var (
	...
	resourcesMap = map[string]int{
		...
		"upcloud_loadbalancer":                            2,
		"upcloud_loadbalancer_backend":                    3,
		"upcloud_loadbalancer_dynamic_backend_member":     4,
		"upcloud_loadbalancer_dynamic_certificate_bundle": 5,
		"upcloud_loadbalancer_frontend":                   6,
		"upcloud_loadbalancer_frontend_rule":              7,
		"upcloud_loadbalancer_frontend_tls_config":        8,
		"upcloud_loadbalancer_manual_certificate_bundle":  9,
		"upcloud_loadbalancer_resolver":                   10,
		"upcloud_loadbalancer_static_backend_member":      11,
		"upcloud_managed_database_logical_database":       12,
		"upcloud_managed_database_mysql":                  13,
		"upcloud_managed_database_postgresql":             14,
		"upcloud_managed_database_user":                   15,
		"upcloud_network":                                 16,
		"upcloud_object_storage":                          17,
		"upcloud_router":                                  18,
		"upcloud_server":                                  19,
		"upcloud_storage":                                 20,
		"upcloud_tag":                                     21,
