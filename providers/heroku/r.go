...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Optional) A friendly name for the Heroku Addon Attachment. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "id",
	...
	resourcesMap = map[string]int{
		...
		"heroku_slug":                              15,
		"heroku_space":                             16,
		"heroku_space_app_access":                  17,
		"heroku_space_inbound_ruleset":             18,
		"heroku_space_peering_connection_accepter": 19,
		"heroku_space_vpn_connection":              20,
		"heroku_team_collaborator":                 21,
		"heroku_team_member":                       22,
	}
)
