...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `The Boundary cluster data source provides information about an existing HCP Boundary cluster.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `The Packer Image data source iteration gets the most recent iteration (or build) of an image, given an iteration id or a channel.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
	...
	dataSourcesMap = map[string]int{
		...
		"hcp_consul_agent_helm_config":       4,
		"hcp_consul_agent_kubernetes_secret": 5,
		"hcp_consul_cluster":                 6,
		"hcp_consul_versions":                7,
		"hcp_hvn":                            8,
		"hcp_hvn_peering_connection":         9,
		"hcp_hvn_route":                      10,
		"hcp_packer_image":                   11,
		"hcp_packer_image_iteration":         12,
		"hcp_packer_iteration":               13,
		"hcp_vault_cluster":                  14,
	}
)
