	...
	Resources = []*Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "metadata",
					Description: `(Required) Standard object's metadata of the jobs created from this template. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata`,
				},
				resource.Attribute{
					Name:        "spec",
					Description: `(Required) Specification of the desired behavior of the job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status ### ` + "`" + `spec` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					...
					Description: `(Optional) Indicates whether a service account token should be automatically mounted.`,
				},
				resource.Attribute{
					Name:        "container",
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Optional) Name of the referent. For more info see [Kubernetes reference](http://kubernetes.io/docs/user-guide/identifiers#names) ### ` + "`" + `dns_config` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "nameservers",
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Optional) Name of the referent. For more info see [Kubernetes reference](http://kubernetes.io/docs/user-guide/identifiers#names) ### ` + "`" + `secret_ref` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "secret_key_ref",
					Description: `(Optional) Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.podIP.. ### ` + "`" + `toleration` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "effect",
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "spec",
					Description: `(Required) Specification of the desired behavior of a job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status ## Nested Blocks ### ` + "`" + `metadata` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "annotations",
					Description: `(Optional) An unstructured key value map stored with the resource that may be used to store arbitrary metadata.`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "volume_id",
					Description: `(Required) Volume ID used to identify the volume in Cinder. For more info see http://releases.k8s.io/HEAD/examples/mysql-cinder-pd/README.md ### ` + "`" + `fc` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "fs_type",
					Description: `(Optional) Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.`,
				...
				resource.Attribute{
					Name:        "secret_ref",
					Description: `(Optional) Name of the authentication secret for RBDUser. If provided overrides keyring. Default is nil. For more info see http://releases.k8s.io/HEAD/examples/volumes/rbd/README.md#how-to-use-it ### ` + "`" + `secret_ref` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Optional) Name of the referent. For more info see [Kubernetes reference](http://kubernetes.io/docs/user-guide/identifiers#names) ### ` + "`" + `vsphere_volume` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "fs_type",
					Description: `(Optional) Filesystem type to mount. Must be a filesystem type supported by the host operating system. Ex. "ext4", "xfs", "ntfs". Implicitly inferred to be "ext4" if unspecified.`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "secret_key_ref",
					Description: `(Optional) Selects a field of the pod: supports metadata.name, metadata.namespace, metadata.labels, metadata.annotations, spec.nodeName, spec.serviceAccountName, status.podIP.. ### ` + "`" + `volume` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "aws_elastic_block_store",
					Description: `(Optional) Represents an AWS Disk resource that is attached to a kubelet's host machine and then exposed to the pod. For more info see [Kubernetes reference](http://kubernetes.io/docs/user-guide/volumes#awselasticblockstore)`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "automount_service_account_token",
					Description: `(Optional) Boolean, ` + "`" + `true` + "`" + ` to enable automatic mounting of the service account token ## Nested Blocks ### ` + "`" + `metadata` + "`" + ` #### Arguments`,
				},
				resource.Attribute{
					Name:        "annotations",
