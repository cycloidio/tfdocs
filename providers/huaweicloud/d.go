...
`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "cluster_type",
					Description: `(Optional) Type of the cluster. Possible values: VirtualMachine, BareMetal. ## Attributes Reference All above argument parameters can be exported as attribute parameters along with attribute reference:`,
				},
				resource.Attribute{
					Name:        "billingMode",
...
`,
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "version",
					Description: `(Optional) Specifies the database version. Only "8.0" is supported now.`,
				},
				resource.Attribute{
					Name:        "availability_zone_mode",
					Description: `(Optional) Specifies the availability zone mode. Currently support ` + "`" + `single` + "`" + ` and 'multi'. Defaults to ` + "`" + `single` + "`" + `. ## Attributes Reference In addition, the following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "flavors",
					Description: `Indicates the flavors information. Structure is documented below. The ` + "`" + `flavors` + "`" + ` block contains:`,
...
`,
	...
	dataSourcesMap = map[string]int{
		...
		"huaweicloud_availability_zones":            1,
		"huaweicloud_cce_cluster_v3":                2,
		"huaweicloud_cce_node_v3":                   3,
		"huaweicloud_cdm_flavors_v1":                4,
		"huaweicloud_compute_availability_zones_v2": 5,
		"huaweicloud_csbs_backup_policy_v1":         6,
		"huaweicloud_csbs_backup_v1":                7,
		"huaweicloud_cts_tracker_v1":                8,
		"huaweicloud_dcs_az_v1":                     9,
		"huaweicloud_dcs_maintainwindow_v1":         10,
		"huaweicloud_dcs_product_v1":                11,
		"huaweicloud_dds_flavors_v3":                12,
		"huaweicloud_dis_partition_v2":              13,
		"huaweicloud_dms_az_v1":                     14,
		"huaweicloud_dms_maintainwindow_v1":         15,
		"huaweicloud_dms_product_v1":                16,
		"huaweicloud_gaussdb_mysql_flavors":         17,
		"huaweicloud_identity_role_v3":              18,
		"huaweicloud_images_image_v2":               19,
		"huaweicloud_kms_data_key_v1":               20,
		"huaweicloud_kms_key_v1":                    21,
		"huaweicloud_networking_network_v2":         22,
		"huaweicloud_networking_port_v2":            23,
		"huaweicloud_networking_secgroup_v2":        24,
		"huaweicloud_networking_subnet_v2":          25,
		"huaweicloud_rds_flavors_v1":                26,
		"huaweicloud_rds_flavors_v3":                27,
		"huaweicloud_rts_software_config_v1":        28,
		"huaweicloud_rts_stack_resource_v1":         29,
		"huaweicloud_rts_stack_v1":                  30,
		"huaweicloud_s3_bucket_object":              31,
		"huaweicloud_sfs_file_sharing_v2":           32,
		"huaweicloud_vbs_backup_policy_v2":          33,
		"huaweicloud_vbs_backup_v2":                 34,
		"huaweicloud_vpc_peering_connection_v2":     35,
		"huaweicloud_vpc_route_ids_v2":              36,
		"huaweicloud_vpc_route_v2":                  37,
		"huaweicloud_vpc_subnet_ids_v1":             38,
		"huaweicloud_vpc_subnet_v1":                 39,
		"huaweicloud_vpc_v1":                        40,
	}
)
