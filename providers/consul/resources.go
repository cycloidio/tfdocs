...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			Name:             "",
			Type:             "consul_acl_token_role_attachment",
			Category:         "Resources",
			ShortDescription: `Allows Terraform to create a link between an ACL token and a role`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "role_id",
					Description: `(Required) The id of the role to attach to the token. ## Attributes Reference The following attributes are exported:`,
				},
				resource.Attribute{
					Name:        "id",
					Description: `The attachment ID.`,
				...
				resource.Attribute{
					Name:        "role_id",
					Description: `The id of the role attached to the token. ## Import ` + "`" + `consul_acl_token_role_attachment` + "`" + ` can be imported. This is especially useful to manage the policies attached to the anonymous and the master tokens with Terraform: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import consul_acl_token_role_attachment.anonymous token_id:role_id ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "config_json",
					Description: `A map of configuration values. ## Import ` + "`" + `consul_config_entry` + "`" + ` can be imported using the syntax ` + "`" + `<kind>/<name>` + "`" + ` if the config entry is in the default partition and default namespace, or ` + "`" + `<partition>/<namespace>/<kind>/<name>` + "`" + ` for config entries in a non-default partition or namespace: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import consul_config_entry.service_splitter 816a195f-6cb1-2e8d-92af-3011ae706318 ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "meta",
					Description: `(Optional, map) Key/value pairs that are associated with the node. ## Import The ` + "`" + `consul_node` + "`" + ` resource can be imported: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import consul_node.example node-name ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Type:             "consul_peering",
			Category:         "Resources",
			ShortDescription: `Cluster Peering https://www.consul.io/docs/connect/cluster-peering can be used to create connections between two or more independent clusters so that services deployed to different partitions or datacenters can communicate. The cluster_peering resource can be used to establish the peering after a peering token has been generated. ~> Cluster peering is currently in technical preview: Functionality associated with cluster peering is subject to change. You should never use the technical preview release in secure environments or production scenarios. Features in technical preview may have performance issues, scaling issues, and limited support. The functionality described here is available only in Consul version 1.13.0 and later.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			Name:             "",
			Type:             "consul_peering_token",
			Category:         "Resources",
			ShortDescription: `Cluster Peering https://www.consul.io/docs/connect/cluster-peering can be used to create connections between two or more independent clusters so that services deployed to different partitions or datacenters can communicate. The cluster_peering_token resource can be used to generate a peering token that can later be used to establish a peering connection. ~> Cluster peering is currently in technical preview: Functionality associated with cluster peering is subject to change. You should never use the technical preview release in secure environments or production scenarios. Features in technical preview may have performance issues, scaling issues, and limited support. The functionality described here is available only in Consul version 1.13.0 and later.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "partition",
					Description: `(Optional, Enterprise Only) The partition the service is associated with. The following attributes are available for each health-check:`,
				},
				resource.Attribute{
					Name:        "check_id",
				...
				resource.Attribute{
					Name:        "timeout",
					Description: `(Required, string) Specifies a timeout for outgoing connections in the case of a HTTP or TCP check.`,
				},
				resource.Attribute{
	...
	resourcesMap = map[string]int{
		...
		"consul_acl_token_role_attachment":   6,
		"consul_admin_partition":             7,
		"consul_agent_service":               8,
		"consul_autopilot_config":            9,
		"consul_catalog_entry":               10,
		"consul_certificate_authority":       11,
		"consul_config_entry":                12,
		"consul_intention":                   13,
		"consul_key_prefix":                  14,
		"consul_keys":                        15,
		"consul_license":                     16,
		"consul_namespace":                   17,
		"consul_namespace_policy_attachment": 18,
		"consul_namespace_role_attachment":   19,
		"consul_network_area":                20,
		"consul_node":                        21,
		"consul_peering":                     22,
		"consul_peering_token":               23,
		"consul_prepared_query":              24,
		"consul_service":                     25,
	}
)
