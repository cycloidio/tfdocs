...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Type:             "astra_roles",
			Category:         "Data Sources",
			ShortDescription: `astra_roles provides a datasource for a list of Astra roles. This can be used to select roles within your Astra Organization.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			Name:             "",
			Type:             "astra_streaming_tenant_tokens",
			Category:         "Data Sources",
			ShortDescription: `astra_streaming_tenant_tokens provides a datasource that lists streaming tenant tokens.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Type:             "astra_users",
			Category:         "Data Sources",
			ShortDescription: `astra_users provides a datasource for a list of Astra users. This can be used to select users within your Astra Organization.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
	...
	dataSourcesMap = map[string]int{
		...
		"astra_role":                      8,
		"astra_roles":                     9,
		"astra_secure_connect_bundle_url": 10,
		"astra_streaming_tenant_tokens":   11,
		"astra_users":                     12,
	}
)
