...
`,
		...
		&resource.Resource{
			Name:             "",
			Type:             "opentelekomcloud_cce_node_ids_v3",
			Category:         "Data Sources",
...
`,
	...
	dataSourcesMap = map[string]int{
		...
		"opentelekomcloud_cce_node_ids_v3":            2,
		"opentelekomcloud_cce_node_v3":                3,
		"opentelekomcloud_compute_bms_flavors_v2":     4,
		"opentelekomcloud_compute_bms_keypairs_v2":    5,
		"opentelekomcloud_compute_bms_nic_v2":         6,
		"opentelekomcloud_compute_bms_server_v2":      7,
		"opentelekomcloud_csbs_backup_policy_v1":      8,
		"opentelekomcloud_csbs_backup_v1":             9,
		"opentelekomcloud_cts_tracker_v1":             10,
		"opentelekomcloud_dcs_az_v1":                  11,
		"opentelekomcloud_dcs_maintainwindow_v1":      12,
