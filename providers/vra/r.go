...
`,
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					...
					Description: `(Required) The id of the catalog item to create the entitlement.`,
				},
				resource.Attribute{
					Name:        "project_id",
				...
				resource.Attribute{
					Name:        "type",
					Description: `Content definition type. ## Import Catalog item entitlement can be imported using the id, e.g. ` + "`" + `$ terraform import vra_catalog_item_entitlement.this 05956583-6488-4e7d-84c9-92a7b7219a15` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
...
`,
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "type",
					Description: `Content definition type. ## Import Catalog source entitlement can be imported using the id, e.g. ` + "`" + `$ terraform import vra_catalog_source_entitlement.this 05956583-6488-4e7d-84c9-92a7b7219a15` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
...
`,
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "value",
					Description: `Tag’s value. ## Attribute Reference`,
				},
				resource.Attribute{
					Name:        "created_at",
				...
				resource.Attribute{
					Name:        "updated_at",
					Description: `Date when the entity was last updated. The date is ISO 8601 and UTC. ## Import To import the fabric compute resource, use the ID as in the following example: ` + "`" + `$ terraform import vra_fabric_compute.this 88fdea8b-92ed-4aa9-b6ee-4670412961b0`,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
...
`,
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "updated_at",
					Description: `Date when the entity was last updated. The date is ISO 8601 and UTC. ## Import To import the fabric datastore vSphere resource, use the ID as in the following example: ` + "`" + `$ terraform import vra_fabric_datastore_vsphere.this 8e0c9a4c-3ab8-48e8-b9d5-0751c871e282`,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
...
`,
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "administrators",
					Description: `(Optional) A list of administrator users associated with the project. Only administrators can manage project's configuration. >`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "constraints",
					Description: `(Optional) A list of storage, network, and extensibility constraints to be applied when provisioning through this project.`,
				},
				resource.Attribute{
					Name:        "custom_properties",
				...
				resource.Attribute{
					Name:        "members",
					Description: `(Optional) A list of member users associated with the project. >`,
				},
				resource.Attribute{
					Name:        "member_roles",
				...
				resource.Attribute{
					...
					Description: `(Optional) The timeout that should be used for cloud template operations and provisioning tasks. The timeout is measured in seconds.`,
				},
				resource.Attribute{
					Name:        "placement_policy",
					Description: `(Optional) The placement policy that will be applied when selecting a cloud zone for provisioning. Must be one of ` + "`" + `DEFAULT` + "`" + ` or ` + "`" + `SPREAD` + "`" + `.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) A list of configurations for zone assignment to a project.`,
				},
			},
			Attributes: []resource.Attribute{},
		},
...
`,
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "compute_ids",
					Description: `(Optional) The ids of the compute resources that will be explicitly assigned to this zone.`,
				},
				resource.Attribute{
					Name:        "custom_properties",
					Description: `(Optional) A list of key value pair of properties that will be used.`,
				},
				resource.Attribute{
					Name:        "description",
					Description: `(Optional) A human-friendly description.`,
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) A human-friendly name used as an identifier for the zone resource instance.`,
				},
				resource.Attribute{
					Name:        "placement_policy",
					Description: `(Optional) The placement policy for the zone. One of ` + "`" + `DEFAULT` + "`" + `, ` + "`" + `SPREAD` + "`" + ` or ` + "`" + `BINPACK` + "`" + `. Default is ` + "`" + `DEFAULT` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "region_id",
					Description: `(Required) The id of the region for which this zone is created.`,
				},
				resource.Attribute{
					Name:        "tags",
					Description: `(Optional) A set of tag keys and optional values that were set on this resource:`,
				},
				resource.Attribute{
					Name:        "key",
					Description: `Tag’s key.`,
				...
				resource.Attribute{
					Name:        "tags_to_match",
					Description: `(Optional) A set of tag keys and optional values for compute resource filtering:`,
				},
				resource.Attribute{
					Name:        "key",
					Description: `Tag’s key.`,
