...
var (
	...
	dataSourcesMap = map[string]int{
		...
		"google_service_account_id_token":                     36,
		"google_dns_keys":                                     37,
		"google_dns_managed_zone":                             38,
		"google_firebase_web_app":                             39,
		"google_firebase_web_app_config":                      40,
		"google_folder":                                       41,
		"google_folder_organization_policy":                   42,
		"google_game_services_game_server_deployment_rollout": 43,
		"google_iam_policy":                                   44,
		"google_iam_role":                                     45,
		"google_iam_testable_permissions":                     46,
		...
		"google_monitoring_app_engine_service":                52,
		"google_monitoring_notification_channel":              53,
		"google_monitoring_uptime_check_ips":                  54,
		"google_netblock_ip_ranges":                           55,
		"google_organization":                                 56,
		"google_project":                                      57,
		"google_project_organization_policy":                  58,
		"google_projects":                                     59,
		"google_redis_instance":                               60,
		"google_secret_manager_secret_version":                61,
		"google_service_account":                              62,
		"google_service_account_access_token":                 63,
