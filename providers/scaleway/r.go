...
var (
	...
	resourcesMap = map[string]int{
		...
		"scaleway_object_bucket":                 16,
		"scaleway_rdb_instance_beta":             17,
		"scaleway_registry_namespace_beta":       18,
		"scaleway_security_group":                19,
		"scaleway_security_group_rule":           20,
		"scaleway_server":                        21,
		"scaleway_ssh_key":                       22,
		"scaleway_token":                         23,
		"scaleway_user_data":                     24,
		"scaleway_volume":                        25,
		"scaleway_volume_attachment":             26,
	}
)
