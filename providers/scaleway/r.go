...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			Name:             "",
			Type:             "scaleway_baremetal_server_beta",
			Category:         "Baremetal Resources (Beta)",
	...
	resourcesMap = map[string]int{
		...
		"scaleway_baremetal_server_beta":    1,
		"scaleway_bucket":                   2,
		"scaleway_instance_ip":              3,
		...
		"scaleway_ip":                       8,
		"scaleway_k8s_cluster_beta":         9,
		"scaleway_k8s_pool_beta":            10,
		"scaleway_lb_backend_beta":          11,
		"scaleway_lb_beta":                  12,
