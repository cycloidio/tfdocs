...
var (
	...
	resourcesMap = map[string]int{
		...
		"scaleway_instance_snapshot":             9,
		"scaleway_instance_volume":               10,
		"scaleway_iot_device":                    11,
		"scaleway_iot_hub":                       12,
		"scaleway_iot_network":                   13,
		"scaleway_iot_routes":                    14,
		"scaleway_k8s_cluster":                   15,
		"scaleway_k8s_pool":                      16,
		"scaleway_lb":                            17,
		"scaleway_lb_backend":                    18,
		"scaleway_lb_certificate":                19,
		"scaleway_lb_frontend":                   20,
		"scaleway_lb_ip":                         21,
