...
var (
	...
	resourcesMap = map[string]int{
		...
		"nutanix_category_key":            1,
		"nutanix_category_value":          2,
		"nutanix_image":                   3,
		"nutanix_karbon_cluster":          4,
		"nutanix_karbon_private_registry": 5,
		"nutanix_network_security_rule":   6,
		"nutanix_project":                 7,
		"nutanix_protection_rule":         8,
		"nutanix_recovery_plan":           9,
		"nutanix_role":                    10,
		"nutanix_subnet":                  11,
		"nutanix_user":                    12,
		"nutanix_virtual_machine":         13,
	}
)
