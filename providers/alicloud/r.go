	...
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "vswitch_ids",
					Description: `(Required, ForceNew) The vswitches where new kubernetes cluster will be located.`,
				},
				resource.Attribute{
					Name:        "new_nat_gateway",
				...
				resource.Attribute{
					Name:        "logtail-ds",
					Description: `You can specific ` + "`" + `IngressDashboardEnabled` + "`" + ` and ` + "`" + `sls_project_name` + "`" + ` in config. If you switch on ` + "`" + `IngressDashboardEnabled` + "`" + ` and ` + "`" + `sls_project_name` + "`" + `,then logtail-ds would use ` + "`" + `sls_project_name` + "`" + ` as default log store. #### Removed params (Never Supported)`,
				},
				resource.Attribute{
					Name:        "vswitch_id",
					Description: `(Deprecated from version 1.91.0)(Required, ForceNew) The vswitch where new kubernetes cluster will be located. Specify one vswitch's id, if it is not specified, a new VPC and VSwicth will be built. It must be in the zone which ` + "`" + `availability_zone` + "`" + ` specified. ### Timeouts ->`,
				},
				resource.Attribute{
					Name:        "create",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "zone_id",
					Description: `(Required from v1.91.0, ForceNew) The Zone to launch the DRDS instance.`,
				},
				resource.Attribute{
					Name:        "instance_charge_type",
				...
				resource.Attribute{
					Name:        "vswitch_id",
					Description: `(Required from v1.91.0, ForceNew) The VSwitch ID to launch in.`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "alicloud_ecs_dedicated_host",
			Category:         "ECS",
			ShortDescription: `Provides a Alibaba Cloud ecs dedicated host resource.`,
			Description:      ``,
			Keywords: []string{
				"ecs",
				"dedicated",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "status",
					Description: `The status of the dedicated host. ## Import Ecs dedicated host can be imported using the id, e.g. ` + "`" + `` + "`" + `` + "`" + ` $ terraform import alicloud_ecs_dedicated_host.default dh-2zedmxxxx ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "image_name",
					Description: `(Optional, Available in 1.92.0+) Name of an image file, indicating the image resource selected when an instance is enabled.`,
				},
				resource.Attribute{
					Name:        "instance_type",
				...
				resource.Attribute{
					...
					Description: `(Optional, Available in 1.92.0+) The name of the system disk. It must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-). Default value: null.`,
				},
				resource.Attribute{
					Name:        "system_disk_description",
					Description: `(Optional, Available in 1.92.0+) The description of the system disk. The description must be 2 to 256 characters in length and cannot start with http:// or https://.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "device",
					Description: `(Optional, Available in 1.92.0+) The mount point of data disk N. Valid values of N: 1 to 16. If this parameter is not specified, the system automatically allocates a mount point to created ECS instances. The name of the mount point ranges from /dev/xvdb to /dev/xvdz in alphabetical order.`,
				},
				resource.Attribute{
					Name:        "category",
				...
				resource.Attribute{
					Name:        "encrypted",
					Description: `(Optional, Available in 1.92.0+) Specifies whether data disk N is to be encrypted. Valid values of N: 1 to 16. Valid values: ` + "`" + `true` + "`" + `: encrypted, ` + "`" + `false` + "`" + `: not encrypted. Default value: ` + "`" + `false` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "kms_key_id",
					Description: `(Optional, Available in 1.92.0+) The CMK ID for data disk N. Valid values of N: 1 to 16.`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Optional, Available in 1.92.0+) The name of data disk N. Valid values of N: 1 to 16. It must be 2 to 128 characters in length. It must start with a letter and cannot start with http:// or https://. It can contain letters, digits, colons (:), underscores (_), and hyphens (-). Default value: null.`,
				},
				resource.Attribute{
					Name:        "description",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "public_key",
					Description: `(ForceNew) You can import an existing public key and using Alicloud key pair to manage it. If this parameter is specified, ` + "`" + `resource_group_id` + "`" + ` is the key pair belongs.`,
				},
				resource.Attribute{
					Name:        "key_file",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional, ForceNew, Available in 1.91.0) The [redundancy type](https://www.alibabacloud.com/help/doc-detail/90589.htm) to enable. Can be "LRS", and "ZRS". Defaults to "LRS".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "sse_algorithm",
					Description: `(Required) The server-side encryption algorithm to use. Possible values: ` + "`" + `AES256` + "`" + ` and ` + "`" + `KMS` + "`" + `.`,
				},
				resource.Attribute{
					Name:        "kms_master_key_id",
					Description: `(optional, Available in 1.92.0+) The alibaba cloud KMS master key ID used for the SSE-KMS encryption. #### Block versioning The versioning supports the following:`,
				},
				resource.Attribute{
					Name:        "status",
