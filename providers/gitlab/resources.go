...
var (
	...
	resourcesMap = map[string]int{
		...
		"gitlab_label":                      12,
		"gitlab_pipeline_schedule":          13,
		"gitlab_pipeline_schedule_variable": 14,
		"gitlab_pipeline_trigger":           15,
		"gitlab_project":                    16,
		"gitlab_project_approval_rule":      17,
		"gitlab_project_cluster":            18,
		"gitlab_project_freeze_period":      19,
		"gitlab_project_hook":               20,
		"gitlab_project_level_mr_approvals": 21,
		"gitlab_project_membership":         22,
		"gitlab_project_mirror":             23,
		"gitlab_project_share_group":        24,
		"gitlab_project_variable":           25,
		"gitlab_service_github":             26,
		"gitlab_service_jira":               27,
		"gitlab_service_pipelines_email":    28,
		"gitlab_service_slack":              29,
		"gitlab_tag_protection":             30,
		"gitlab_user":                       31,
	}
)
