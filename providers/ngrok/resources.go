...
var (
	...
	resourcesMap = map[string]int{
		...
		"ngrok_agent_ingress":             0,
		"ngrok_api_key":                   1,
		"ngrok_certificate_authority":     2,
		"ngrok_credential":                3,
		"ngrok_endpoint_configuration":    4,
		"ngrok_event_destination":         5,
		"ngrok_event_subscription":        6,
		"ngrok_ip_policy":                 7,
		"ngrok_ip_policy_rule":            8,
		"ngrok_ip_restriction":            9,
