...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			Name:             "",
			Type:             "profitbricks_profitbricks_image",
			Category:         "Data Sources",
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information on a ProfitBricks K8s Cluster`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information on a ProfitBricks K8s Node Pool`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information on a ProfitBricks Lans`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "profitbricks_profitbricks_location",
			Category:         "Data Sources",
		...
		&resource.Resource{
			Name:             "",
			Type:             "profitbricks_profitbricks_resource",
			Category:         "Data Sources",
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information on a ProfitBricks Servers`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "profitbricks_protifbricks_private_crossconnect",
			Category:         "Data Sources",
			ShortDescription: `Get information on a ProfitBricks Private Crossconnects`,
			Description:      ``,
			Keywords:         []string{},
			Arguments: []resource.Attribute{
				resource.Attribute{
	...
	dataSourcesMap = map[string]int{
		...
		"profitbricks_profitbricks_datacenter":           0,
		"profitbricks_profitbricks_image":                1,
		"profitbricks_profitbricks_k8s_cluster":          2,
		"profitbricks_profitbricks_k8s_node_pool":        3,
		"profitbricks_profitbricks_lan":                  4,
		"profitbricks_profitbricks_location":             5,
		"profitbricks_profitbricks_resource":             6,
		"profitbricks_profitbricks_server":               7,
		"profitbricks_profitbricks_snapshot":             8,
		"profitbricks_protifbricks_private_crossconnect": 9,
	}
)
