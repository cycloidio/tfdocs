...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			Name:             "",
			Type:             "bigip_bigiq_as3.html",
			Category:         "Resources",
			ShortDescription: `Provides details about bigiq as3 resource`,
			Description:      ``,
			Keywords: []string{
				"bigiq",
				"as3.html",
		...
		&resource.Resource{
			Name:             "",
			Type:             "bigip_common_license_manage_bigiq",
			Category:         "Resources",
	...
	resourcesMap = map[string]int{
		...
		"bigip_as3":                             0,
		"bigip_bigiq_as3.html":                  1,
		"bigip_cm_device":                       2,
		"bigip_cm_devicegroup":                  3,
		"bigip_command":                         4,
		"bigip_common_license_manage_bigiq":     5,
		"bigip_do":                              6,
		"bigip_ltm_datagroup":                   7,
		"bigip_ltm_irule":                       8,
		"bigip_ltm_monitor":                     9,
		"bigip_ltm_node":                        10,
		"bigip_ltm_persistence_profile_cookie":  11,
		"bigip_ltm_persistence_profile_dstaddr": 12,
		"bigip_ltm_persistence_profile_srcaddr": 13,
		"bigip_ltm_persistence_profile_ssl":     14,
		"bigip_ltm_policy":                      15,
		"bigip_ltm_pool":                        16,
		"bigip_ltm_pool_attachment":             17,
		"bigip_ltm_profile_client_ssl":          18,
		"bigip_ltm_profile_fasthttp":            19,
		"bigip_ltm_profile_fastl4":              20,
		"bigip_ltm_profile_http":                21,
		"bigip_ltm_profile_http2":               22,
		"bigip_ltm_profile_httpcompress":        23,
		"bigip_ltm_profile_oneconnect":          24,
		"bigip_ltm_profile_server_ssl":          25,
		"bigip_ltm_profile_tcp":                 26,
		"bigip_ltm_snat":                        27,
		"bigip_ltm_snatpool":                    28,
		"bigip_ltm_virtual_address":             29,
		"bigip_ltm_virtual_server":              30,
		"bigip_net_route":                       31,
		"bigip_net_selfip":                      32,
		"bigip_net_vlan":                        33,
		"bigip_ssl_certificate":                 34,
		"bigip_ssl_key":                         35,
		"bigip_sys_dns":                         36,
		"bigip_sys_iapp":                        37,
		"bigip_sys_ntp":                         38,
		"bigip_sys_provision":                   39,
		"bigip_sys_snmp":                        40,
		"bigip_sys_snmp_traps":                  41,
	}
)
