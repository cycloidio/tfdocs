...
var (
	...
	resourcesMap = map[string]int{
		...
		"bigip_command":                         3,
		"bigip_common_license_manage_bigiq":     4,
		"bigip_do":                              5,
		"bigip_ltm_datagroup":                   6,
		"bigip_ltm_irule":                       7,
		"bigip_ltm_monitor":                     8,
		"bigip_ltm_node":                        9,
		"bigip_ltm_persistence_profile_cookie":  10,
		"bigip_ltm_persistence_profile_dstaddr": 11,
		"bigip_ltm_persistence_profile_srcaddr": 12,
		"bigip_ltm_persistence_profile_ssl":     13,
		"bigip_ltm_policy":                      14,
		"bigip_ltm_pool":                        15,
		"bigip_ltm_pool_attachment":             16,
		"bigip_ltm_profile_client_ssl":          17,
		"bigip_ltm_profile_fasthttp":            18,
		"bigip_ltm_profile_fastl4":              19,
		"bigip_ltm_profile_http":                20,
		"bigip_ltm_profile_http2":               21,
		"bigip_ltm_profile_httpcompress":        22,
		"bigip_ltm_profile_oneconnect":          23,
		"bigip_ltm_profile_server_ssl":          24,
		"bigip_ltm_profile_tcp":                 25,
		"bigip_ltm_snat":                        26,
		"bigip_ltm_snatpool":                    27,
		"bigip_ltm_virtual_address":             28,
		"bigip_ltm_virtual_server":              29,
		"bigip_net_route":                       30,
		"bigip_net_selfip":                      31,
		"bigip_net_vlan":                        32,
		"bigip_ssl_certificate":                 33,
		"bigip_ssl_key":                         34,
		"bigip_sys_dns":                         35,
		"bigip_sys_iapp":                        36,
		"bigip_sys_ntp":                         37,
		"bigip_sys_provision":                   38,
		"bigip_sys_snmp":                        39,
		"bigip_sys_snmp_traps":                  40,
	}
)
