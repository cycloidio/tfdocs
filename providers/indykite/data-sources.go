...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			Name:             "",
			Type:             "indykite_application_agents",
			Category:         "Data Sources",
			ShortDescription: ``,
			Description:      ``,
			Keywords:         []string{},
		...
		&resource.Resource{
			Name:             "",
			Type:             "indykite_application_spaces",
			Category:         "Data Sources",
			ShortDescription: ``,
			Description:      ``,
			Keywords:         []string{},
	...
	dataSourcesMap = map[string]int{
		...
		"indykite_application_agents": 2,
		"indykite_application_space":  3,
		"indykite_application_spaces": 4,
		"indykite_applications":       5,
		"indykite_customer":           6,
		"indykite_oauth2_application": 7,
		"indykite_oauth2_provider":    8,
		"indykite_tenant":             9,
		"indykite_tenants":            10,
	}
)
