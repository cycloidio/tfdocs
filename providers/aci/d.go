...
var (
	...
	dataSourcesMap = map[string]int{
		...
		"aci_contract":                                 31,
		"aci_contract_subject":                         32,
		"aci_destination_of_redirected_traffic":        33,
		"aci_end_point_retention_policy":               34,
		"aci_epg_to_contract":                          35,
		"aci_epg_to_domain":                            36,
		"aci_epg_to_static_path":                       37,
		"aci_epgs_using_function":                      38,
		"aci_external_network_instance_profile":        39,
		"aci_fabric_if_pol":                            40,
		"aci_fabric_node_member":                       41,
		"aci_fabric_path_ep":                           42,
		"aci_fc_domain":                                43,
		"aci_fex_bundle_group":                         44,
		"aci_fex_profile":                              45,
		"aci_filter":                                   46,
		"aci_filter_entry":                             47,
		"aci_firmware_download_task":                   48,
		"aci_firmware_group":                           49,
		"aci_firmware_policy":                          50,
		"aci_function_node":                            51,
		"aci_imported_contract":                        52,
		"aci_interface_fc_policy":                      53,
		"aci_l2_interface_policy":                      54,
		"aci_l3_domain_profile":                        55,
		"aci_l3_ext_subnet":                            56,
		"aci_l3_outside":                               57,
		"aci_l4_l7_service_graph_template":             58,
		"aci_lacp_policy":                              59,
		"aci_leaf_access_bundle_policy_group":          60,
		"aci_leaf_access_port_policy_group":            61,
		"aci_leaf_interface_profile":                   62,
		"aci_leaf_profile":                             63,
		"aci_leaf_selector":                            64,
		"aci_lldp_interface_policy":                    65,
		"aci_local_user":                               66,
		"aci_logical_device_context":                   67,
		"aci_logical_interface_context":                68,
		"aci_logical_interface_profile":                69,
		"aci_logical_node_profile":                     70,
		"aci_logical_node_to_fabric_node":              71,
		"aci_maintenance_policy":                       72,
		"aci_miscabling_protocol_interface_policy":     73,
		"aci_monitoring_policy":                        74,
		"aci_node_block":                               75,
		"aci_node_block_firmware":                      76,
		"aci_ospf_interface_policy":                    77,
		"aci_physical_domain":                          78,
		"aci_port_security_policy":                     79,
		"aci_ranges":                                   80,
		"aci_service_redirect_policy":                  81,
		"aci_span_destination_group":                   82,
		"aci_span_source_group":                        83,
		"aci_span_sourcedestination_group_match_label": 84,
		"aci_spine_interface_profile":                  85,
		"aci_spine_port_policy_group":                  86,
		"aci_spine_port_selector":                      87,
		"aci_spine_profile":                            88,
		"aci_spine_switch_association":                 89,
		"aci_subnet":                                   90,
		"aci_taboo_contract":                           91,
		"aci_tenant":                                   92,
		"aci_trigger_scheduler":                        93,
		"aci_vlan_encapsulationfor_vxlan_traffic":      94,
		"aci_vlan_pool":                                95,
		"aci_vmm_domain":                               96,
		"aci_vpc_explicit_protection_group":            97,
		"aci_vrf":                                      98,
		"aci_vsan_pool":                                99,
		"aci_vxlan_pool":                               100,
		"aci_x509_certificate":                         101,
	}
)
