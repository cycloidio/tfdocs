...
var (
	...
	resourcesMap = map[string]int{
		...
		"aci_bridge_domain":                            12,
		"aci_cdp_interface_policy":                     13,
		"aci_cloud_applicationcontainer":               14,
		"aci_cloud_availability_zone":                  15,
		"aci_cloud_aws_provider":                       16,
		"aci_cloud_cidr_pool":                          17,
		"aci_cloud_context_profile":                    18,
		"aci_cloud_domain_profile":                     19,
		"aci_cloud_endpoint_selector":                  20,
		"aci_cloud_endpoint_selectorfor_external_epgs": 21,
		"aci_cloud_epg":                                22,
		"aci_cloud_external_epg":                       23,
		"aci_cloud_provider_profile":                   24,
		"aci_cloud_providers_region":                   25,
		"aci_cloud_subnet":                             26,
		"aci_cloud_vpn_gateway":                        27,
		"aci_configuration_export_policy":              28,
		"aci_configuration_import_policy":              29,
		"aci_contract":                                 30,
		"aci_contract_subject":                         31,
		"aci_destination_of_redirected_traffic":        32,
		"aci_end_point_retention_policy":               33,
		"aci_epg_to_contract":                          34,
		"aci_epg_to_domain":                            35,
		"aci_epg_to_static_path":                       36,
		"aci_epgs_using_function":                      37,
		"aci_external_network_instance_profile":        38,
		"aci_fabric_if_pol":                            39,
		"aci_fabric_node_member":                       40,
		"aci_fc_domain":                                41,
		"aci_fex_bundle_group":                         42,
		"aci_fex_profile":                              43,
		"aci_filter":                                   44,
		"aci_filter_entry":                             45,
		"aci_firmware_download_task":                   46,
		"aci_firmware_group":                           47,
		"aci_firmware_policy":                          48,
		"aci_function_node":                            49,
		"aci_imported_contract":                        50,
		"aci_interface_fc_policy":                      51,
		"aci_l2_interface_policy":                      52,
		"aci_l3_domain_profile":                        53,
		"aci_l3_ext_subnet":                            54,
		"aci_l3_outside":                               55,
		"aci_l4_l7_service_graph_template":             56,
		"aci_lacp_policy":                              57,
		"aci_leaf_access_bundle_policy_group":          58,
		"aci_leaf_access_port_policy_group":            59,
		"aci_leaf_interface_profile":                   60,
		"aci_leaf_profile":                             61,
		"aci_leaf_selector":                            62,
		"aci_lldp_interface_policy":                    63,
		"aci_local_user":                               64,
		"aci_logical_device_context":                   65,
		"aci_logical_interface_context":                66,
		"aci_logical_interface_profile":                67,
		"aci_logical_node_profile":                     68,
		"aci_logical_node_to_fabric_node":              69,
		"aci_maintenance_policy":                       70,
		"aci_miscabling_protocol_interface_policy":     71,
		"aci_monitoring_policy":                        72,
		"aci_node_block":                               73,
		"aci_node_block_firmware":                      74,
		"aci_ospf_interface_policy":                    75,
		"aci_physical_domain":                          76,
		"aci_pod_maintenance_group":                    77,
		"aci_port_security_policy":                     78,
		"aci_ranges":                                   79,
		"aci_service_redirect_policy":                  80,
		"aci_span_destination_group":                   81,
		"aci_span_source_group":                        82,
		"aci_span_sourcedestination_group_match_label": 83,
		"aci_spine_interface_profile":                  84,
		"aci_spine_port_policy_group":                  85,
		"aci_spine_port_selector":                      86,
		"aci_spine_profile":                            87,
		"aci_spine_switch_association":                 88,
		"aci_subnet":                                   89,
		"aci_taboo_contract":                           90,
		"aci_tenant":                                   91,
		"aci_trigger_scheduler":                        92,
		"aci_vlan_encapsulationfor_vxlan_traffic":      93,
		"aci_vlan_pool":                                94,
		"aci_vmm_domain":                               95,
		"aci_vpc_explicit_protection_group":            96,
		"aci_vrf":                                      97,
		"aci_vsan_pool":                                98,
		"aci_vxlan_pool":                               99,
		"aci_x509_certificate":                         100,
	}
)
