...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "order",
					Description: `Order in which the ASN should be prepended to Set AS Path.`,
				},
				resource.Attribute{
					Name:        "set_dampening",
				...
				resource.Attribute{
					Name:        "half_life",
					Description: `Half Life of the Set Dampening object, the maximum value for this field is 60 in minutes and the half_life time must be at least 9% of the maximum_suppress_time.`,
				},
				resource.Attribute{
					Name:        "reuse",
					Description: `Reuse Limit of the Set Dampening object, the maximum value for this field is 20000.`,
				},
				resource.Attribute{
					Name:        "suppress",
					Description: `Suppress Limit of the Set Dampening object, the maximum value for this field is 20000. Suppress limit must be larger than reuse limit.`,
				},
				resource.Attribute{
					Name:        "max_suppress_time",
					Description: `Max Suppress Time of the Set Dampening object, the maximum value for this field is 255 in minutes and should not be less than suppress limit. ## Importing ## An existing Action Rule Profile can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_action_rule_profile.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "pref_gr_memb",
					Description: `(Optional) Represents parameter used to determine if EPgs can be divided in a the context can be divided into two subgroups. Allowed values are "disabled" and "enabled". Default is "disabled".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) Relation to Provided Contracts (vzBrCP class). ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the Any. ## Importing An existing Any object can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: <https://www.terraform.io/docs/import/index.html> ` + "`" + `` + "`" + `` + "`" + `bash terraform import aci_any.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) Relation to DHCP Relay policy (Point to class dhcpRelayP). Cardinality - N_TO_ONE. Type - String. If the intent is to configure a DHCP Relay label please leverage the [aci_bd_dhcp_label](https://registry.terraform.io/providers/CiscoDevNet/aci/latest/docs/resources/bd_dhcp_label) resource.`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			Name:             "",
			Type:             "aci_bulk_epg_to_static_path",
			Category:         "Application Management",
			ShortDescription: `Manages ACI EPG to Static Paths in bulk`,
			Description:      ``,
			Keywords: []string{
				"application",
				"management",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "static_path",
					Description: `(Optional) A block representing a Static Path object. Type: Block.`,
				},
				resource.Attribute{
					Name:        "interface_dn",
					Description: `(Required) Distinguished name of the interface to assign to this EPG. Type: String.`,
				},
				resource.Attribute{
					Name:        "encap",
					Description: `(Required) Encapsulation to use for the Static Path (for example: vlan-100). Type: String.`,
				},
				resource.Attribute{
					Name:        "deployment_immediacy",
					Description: `(Optional) Deployment immediacy of the Static Path. Allowed values: "immediate", "lazy". Default value: "lazy". Type: String.`,
				},
				resource.Attribute{
					Name:        "mode",
					Description: `(Optional) Mode of the static association of the interface. Allowed values: "regular", "native", "untagged". Default value: "regular". Type: String.`,
				},
				resource.Attribute{
					Name:        "primary_encap",
					Description: `(Optional) Primary encapsulation for the Static Path object (used for micro-segmentation). Allowed values: "vlan-xxx" or "unknown". Default value: "unknown". Type: String. ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the EPG for which the static paths are configured for. ## Importing ## The existing Static Paths of an EPG can be [imported][docs-import] into this resource using the EPG Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_bulk_epg_to_static_path.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud Account`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"account",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "access_type",
					Description: `(Optional) Authentication type for the Cloud Account (managed=no credentials required (IAM), credentials=using accessKeys). Allowed values are "credentials" and "managed". Type: String.`,
				},
				resource.Attribute{
					Name:        "account_id",
				...
				resource.Attribute{
					Name:        "vendor",
					Description: `(Required) Vendor of the Cloud Account object. Allowed values are "aws", "azure", "gcp" and "unknown". Type: String.`,
				},
				resource.Attribute{
					Name:        "relation_cloud_rs_account_to_access_policy",
					Description: `(Optional) Represents the relation to the Access policy to be used (class cloudAccessPolicy). Type: String.`,
				},
				resource.Attribute{
					Name:        "relation_cloud_rs_credentials",
					Description: `(Optional) Represents the relation to a Credentials to use to manage the account (class cloudCredentials). If access_type is credentials, relation to the Cloud Credentials to use Type: String. ## Importing ## An existing Cloud Account can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_account.example "<Dn>" ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Type:             "aci_cloud_ad",
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud Active Directory`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"ad",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Required) Id of the Azure Active Directory.`,
				},
				resource.Attribute{
					Name:        "annotation",
					Description: `(Optional) Annotation of the object Active Directory.`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Optional) Name of the Active Directory object. ## Importing ## An existing Active Directory can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_ad.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Cloud Context Profile object.`,
				},
				resource.Attribute{
					Name:        "primary_cidr",
					Description: `(Required) Primary CIDR block of the Cloud Context Profile object.`,
				},
				resource.Attribute{
					Name:        "region",
					Description: `(Required) Region of the Cloud Context Profile object.`,
				},
				resource.Attribute{
					Name:        "cloud_vendor",
					Description: `(Required) Name of the vendor. Allowed values are "aws", "azure", "gcp".`,
				},
				resource.Attribute{
					Name:        "annotation",
					Description: `(Optional) Annotation of the Cloud Context Profile object.`,
				},
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) Name alias of the Cloud Context Profile object.`,
				},
				resource.Attribute{
					Name:        "type",
					Description: `(Optional) Type of the Cloud Context Profile object. Allowed values are "regular", "shadow", "hosted" and "container-overlay". Default is "regular".`,
				},
				resource.Attribute{
					Name:        "hub_network",
				...
				resource.Attribute{
					...
					Description: `(Optional) Relation to a AWS Flow Log Policy (class cloudAwsFlowLogPol). Cardinality - N TO ONE. Type - String.`,
				},
				resource.Attribute{
					Name:        "relation_cloud_rs_to_ctx",
					Description: `(Required) Relation to a VRF (class fvCtx). Cardinality - N TO ONE. Type - String.`,
				},
				resource.Attribute{
					Name:        "cloud_brownfield",
					Description: `(Optional) Option to import brownfield virtual network from cloud provider. Type - String.`,
				},
				resource.Attribute{
					Name:        "access_policy_type",
					Description: `(Optional) Type of cloud context access policy. Allowed values are "read-only", "routing-only", "inherited", "routing-security". Type - String.`,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud Credential to manage the cloud resources`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"credentials",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Cloud Credential object to manage the cloud resources.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "relation_cloud_rs_ad",
					Description: `(Optional) Represents the relation to an Azure Active Directory (class cloudAD). Type String. ## Importing ## An existing Cloud Credential to manage the cloud resources can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_credentials.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud External Network`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"external",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Cloud External Network.`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "vrf_dn",
					Description: `(Required) Distinguished name of the VRF. Note that the VRF has to be created under the infra tenant.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "all_regions",
					Description: `(Optional) Selects all regions available to the Cloud External Network. This option is always set to "yes" for Azure cAPICs.`,
				},
				resource.Attribute{
					Name:        "regions",
				...
				resource.Attribute{
					Name:        "cloud_vendor",
					Description: `(Optional) Name of the vendor. Allowed values are "aws", "azure", "gcp". ## Importing ## An existing Cloud External Network can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_external_network.example "<Dn>" ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud Subnet Pool for IPsec Tunnels`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"ipsec",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "subnet_pool",
					Description: `(Required) Subnetpool address of the Subnet Pool for IPsec Tunnels object.`,
				},
				resource.Attribute{
					Name:        "annotation",
					Description: `(Optional) Annotation of the Subnet Pool for IPsec Tunnels object. ## Importing ## An existing Cloud Subnet Pool for IPsec Tunnels can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_ipsec_tunnel_subnet_pool.example "<Dn>" ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "ip",
					Description: `(Required) CIDR block of the Cloud Subnet object.`,
				},
				resource.Attribute{
					Name:        "name",
				...
				resource.Attribute{
					Name:        "scope",
					Description: `(Optional) List of domain applicable to the capability. Allowed values are "public", "private" and "shared". Default is ["private"]. Use the sorted scope list to handle identical changes.`,
				},
				resource.Attribute{
					Name:        "usage",
				...
				resource.Attribute{
					...
					Description: `(Optional) Subnet Group Label of the Cloud Subnet object. It is only applicable to the GCP vendor. ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the Cloud Subnet. ## Importing ## An existing Cloud Subnet can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_subnet.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Cloud Template for VPN Network`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"vpn",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					...
					Description: `(Required) Distinguished name of the parent TemplateforExternalNetwork object.`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Cloud VPN Network object.`,
				},
				resource.Attribute{
					Name:        "remote_site_id",
					Description: `(Optional) Remote Site ID. Allowed range is 0-1000 and default value is "0".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "pre_shared_key",
					Description: `(Optional) Pre Shared Key for all tunnels to this peeraddr.`,
				},
				resource.Attribute{
					Name:        "bgp_peer_asn",
		...
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages Cloud ACI Inter-VRF Leaked Routes`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"vrf",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "vrf_dn",
					Description: `(Required) Distinguished name of the destination VRF object, which is mapped to the Inter-VRF Leaked Route object. ## Importing ## An existing Inter-VRF Leaked Route can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_cloud_vrf_leak_routes.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			ShortDescription: `Manages ACI Concrete Device`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Concrete Device object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					...
					Description: `(Optional) Distinguished name of the VMM controller object. This can only be used for Virtual L4-L7 Devices. Type: String.`,
				},
				resource.Attribute{
					Name:        "vm_name",
					Description: `(Optional) The name of the Virtual Machine (VM) in the vCenter on which the device in the L4-L7 device cluster is hosted. It uniquely identifies the VM. This can only be used for Virtual L4-L7 Devices. Type: String. ## Importing ## An existing Concrete Device can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_concrete_device.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI Concrete Interface`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Concrete Interface object.`,
				},
				resource.Attribute{
					Name:        "encap",
				...
				resource.Attribute{
					...
					Description: `(Optional) Represents a relation from the Concrete Interface to the Physical Port on the Leaf (class fabricPathEp). Type: String. ## Importing ## An existing Concrete Interface can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_concrete_interface.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "filter.filter_entry.annotation",
					Description: `(Optional) Annotation for object filter entry.`,
				},
				resource.Attribute{
					Name:        "filter.filter_entry.description",
		...
		&resource.Resource{
			...
			Category:         "Contract",
			ShortDescription: `Manages ACI Contract Subject Filter`,
			Description:      ``,
			Keywords: []string{
				"contract",
				"subject",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "filter_dn",
					Description: `(Required) Distinguished name of the Filter object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					...
					Description: `(Optional) Priority override of the Contract Subject Filter object. Allowed values are "default", "level1", "level2", "level3", and the default value is "default". Type: String. ## Importing ## An existing Contract Subject Filter can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_contract_subject_filter.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "Contract",
			ShortDescription: `Manages ACI One Way Filter`,
			Description:      ``,
			Keywords: []string{
				"contract",
				"subject",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "priority_override",
					Description: `(Optional) Priority override of the Filter object. It is only used when action is set to deny. Allowed values are "default", "level1", "level2", "level3", and the default value is "default". Type: String. ## Importing ## An existing Filter can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_contract_subject_one_way_filter.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the External Network Instance Profile object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "exception_tag",
					Description: `(Optional) Exception tag of the External Network Instance Profile object. Allowed value range is "0" - "512".`,
				},
				resource.Attribute{
					Name:        "flood_on_encap",
				...
				resource.Attribute{
					Name:        "match_t",
					Description: `(Optional) The provider label match criteria of the External Network Instance Profile object. Allowed values are "All", "AtleastOne", "AtmostOne" and "None". Default is "AtleastOne".`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "pref_gr_memb",
					Description: `(Optional) Represents parameter used to determine if an External EPG is part of a group that does not require a contract for communication. Allowed values are "include" and "exclude". Default is "exclude".`,
				},
				resource.Attribute{
					Name:        "prio",
					Description: `(Optional) The QoS priority class identifier of the External Network Instance Profile object. Allowed values are "unspecified", "level1", "level2", "level3", "level4", "level5" and "level6". Default is "unspecified".`,
				},
				resource.Attribute{
					Name:        "target_dscp",
					Description: `(Optional) The target differentiated services code point (DSCP) of the path attached to the layer 3 outside profile. Allowed values are "CS0", "CS1", "AF11", "AF12", "AF13", "CS2", "AF21", "AF22", "AF23", "CS3", "AF31", "AF32", "AF33", "CS4", "AF41", "AF42", "AF43", "CS5", "VA", "EF", "CS6", "CS7" and "unspecified". Default is "unspecified".`,
				...
				resource.Attribute{
					...
					Description: `(Optional) Relation to Route Control Profiles (class rtctrlProfile). Every direction(export/import) allows only one object. Cardinality - N_TO_M. Type: Block.`,
				},
				resource.Attribute{
					Name:        "relation_fv_rs_cons",
				...
				resource.Attribute{
					Name:        "relation_fv_rs_prot_by",
					Description: `(Optional) Relation to Taboo Contracts (vzTaboo). Cardinality - N_TO_M. Type - Set of String. ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the External Network Instance Profile. ## Importing An existing External Network Instance Profile can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_external_network_instance_profile.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "port_type",
					Description: `(Optional) The Type of the Port Configuration object. Allowed values are "access", "fabric". Default value is "access". Type: String.`,
				},
				resource.Attribute{
					Name:        "role",
					Description: `(Optional) The Role of the Port Configuration object. Allowed values are "leaf", "spine". Default value is "leaf". Type: String.`,
				},
				resource.Attribute{
					Name:        "policy_group",
					Description: `(Optional) The Distinguished Name of the Policy Group being associated with the Port Configuration object. The Policy Group and Breakout cannot be configured simultaneously. Type: String.`,
				},
				resource.Attribute{
					Name:        "breakout",
					Description: `(Optional) The Breakout Map of the Port Configuration object. Allowed values are "100g-2x", "100g-4x", "10g-4x", "25g-4x", "50g-8x", "none". The Policy Group and Breakout cannot be configured simultaneously. Type: String.`,
				},
				resource.Attribute{
					Name:        "admin_state",
					Description: `(Optional) The Admin State of the Port Configuration object. Allowed values are "up", "down". Default value is "up". Type: String.`,
				},
				resource.Attribute{
					Name:        "pc_member",
				...
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) The Name Alias of the Port Configuration object. Type: String. ## Importing ## An existing Port Configuration can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_interface_config.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Tenant Policies",
			ShortDescription: `Manages ACI IP SLA Monitoring Policy`,
			Description:      ``,
			Keywords: []string{
				"tenant",
				"policies",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the IP SLA Monitoring Policy object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "http_uri",
					Description: `(Optional) URI used for HTTP probing. This is required when ` + "`" + `sla_type` + "`" + ` is set to "http". Type: String.`,
				},
				resource.Attribute{
					Name:        "http_version",
					Description: `(Optional) HTTP Version used for probing. Allowed values are "HTTP/1.0", "HTTP/1.1", and default value is "HTTP/1.0". Type: String.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) Traffic Class Value indicates class or priority of IPv6 packet. Allowed range is 0-255 and default value is "0". Type: String.`,
				},
				resource.Attribute{
					Name:        "request_data_size",
					Description: `(Optional) Request Data Size. Allowed range is 0-17512 and default value is "28". Type: String.`,
				},
				resource.Attribute{
					Name:        "sla_detect_multiplier",
					Description: `(Optional) Detect Multiplier value for number of missed probes. Allowed range is 1-100 and default value is "3". Type: String.`,
				},
				resource.Attribute{
					Name:        "sla_frequency",
					Description: `(Optional) The SLA frequency value for forwarding packets. Allowed range is 1-300 and default value is "60". Type: String.`,
				},
				resource.Attribute{
					Name:        "sla_port",
					Description: `(Optional) The SLA destination port number. This is required when ` + "`" + `sla_type` + "`" + ` is set to "tcp". Type: String.`,
				},
				resource.Attribute{
					Name:        "sla_type",
					Description: `(Optional) The SLA type. Allowed values are "http", "icmp", "l2ping", "tcp", and default value is "icmp". Type: String.`,
				},
				resource.Attribute{
					Name:        "threshold",
					Description: `(Optional) The threshold value at which the SLA is considered as failed. Allowed range is 0-604800000 and default value is "900". Type: String.`,
				},
				resource.Attribute{
					Name:        "timeout",
					Description: `(Optional) The amount of time between authentication attempts. Allowed range is 0-604800000 and default value is "900". Type: String. ## Importing ## An existing IP SLA Monitoring Policy can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_ip_sla_monitoring_policy.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "L3Out",
			ShortDescription: `Manages ACI External EPG Subnet`,
			Description:      ``,
			Keywords: []string{
				"l3out",
				"l3",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "ip",
					Description: `(Required) ip of the External EPG Subnet object.`,
				},
				resource.Attribute{
					Name:        "aggregate",
					Description: `(Optional) Aggregate Routes of the External EPG Subnet object. Allowed values are "import-rtctrl", "export-rtctrl", "shared-rtctrl" and "none".`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) name_alias of the External EPG Subnet object.`,
				},
				resource.Attribute{
					Name:        "scope",
				...
				resource.Attribute{
					...
					Description: `(Optional) Relation to a Route Summarization Policy (class rtsumARtSummPol). ## Importing ## An existing External EPG Subnet can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l3_ext_subnet.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the L3 Outside object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "enforce_rtctrl",
					Description: `(Optional) Enforce route control type. Allowed values are "import" and "export". Default is "export". Type - String.`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "target_dscp",
					Description: `(Optional) The target differentiated services code point (DSCP) of the path attached to the L3 Outside object. Allowed values are "CS0", "CS1", "AF11", "AF12", "AF13", "CS2", "AF21", "AF22", "AF23", "CS3", "AF31", "AF32", "AF33", "CS4", "AF41", "AF42", "AF43", "CS5", "VA", "EF", "CS6", "CS7" and "unspecified". Default is "unspecified".`,
				},
				resource.Attribute{
					Name:        "mpls_enabled",
					Description: `(Optional) Indiscate whether MPLS is enabled or not. Allowed values are "no", "yes". Default value is "no".`,
				},
				resource.Attribute{
					Name:        "relation_l3ext_rs_dampening_pol",
					Description: `(Optional) Relation to Route Control Profile for Dampening Policies (class rtctrlProfile). Can't configure multiple Dampening Policies for the same address-family. Cardinality - N_TO_M. Type - Block.`,
				},
				resource.Attribute{
					Name:        "relation_l3ext_rs_ectx",
					Description: `(Required) Relation to VRF (class fvCtx). Target VRF object should belong to the parent tenant or be a shared object. Cardinality - N_TO_ONE. Type - String.`,
				},
				resource.Attribute{
					Name:        "relation_l3ext_rs_interleak_pol",
					Description: `(Optional) Relation to Route Profile for Interleak (class rtctrlProfile). Interleak Policy object should belong to the parent tenant or be a shared object. Cardinality - N_TO_ONE. Type - String.`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "source",
					Description: `(Optional) Route Map Source for the Route Profile for Redistribution. Allowed values are "attached-host", "direct", "static". Default value is "static".`,
				},
				resource.Attribute{
					Name:        "target_dn",
					Description: `(Required) Distinguished name of the Route Control Profile for the Route Profile for Redistribution. ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the L3 Outside. ## Importing An existing L3 Outside can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l3_outside.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "node_dn",
					Description: `(Required) Distinguished name of the node of the L3out floating SVI object.`,
				},
				resource.Attribute{
					Name:        "encap",
					Description: `(Required) Port encapsulation of the L3out floating SVI object.`,
				},
				resource.Attribute{
					Name:        "addr",
					Description: `(Optional) Peer address of the L3out floating SVI object. Default value: "0.0.0.0".`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "autostate",
					Description: `(Optional) Autostate of the L3out floating SVI object. Allowed values are "disabled" and "enabled". Default value is "disabled".`,
				},
				resource.Attribute{
					Name:        "encap_scope",
					Description: `(Optional) Encap scope of the L3out floating SVI object. Allowed values are "ctx" and "local". Default value is "local".`,
				},
				resource.Attribute{
					Name:        "if_inst_t",
					Description: `(Optional) Interface type of the L3out floating SVI object. Allowed values are "ext-svi", "l3-port", "sub-interface" and "unspecified". Default value is "unspecified".`,
				},
				resource.Attribute{
					Name:        "ipv6_dad",
					Description: `(Optional) IPv6 dad of the L3out floating SVI object. Allowed values are "disabled" and "enabled". Default value is "enabled".`,
				},
				resource.Attribute{
					Name:        "ll_addr",
					Description: `(Optional) Link local address of the L3out floating SVI object. Default value: "::".`,
				},
				resource.Attribute{
					Name:        "mac",
				...
				resource.Attribute{
					Name:        "mode",
					Description: `(Optional) BGP domain mode of the L3out floating SVI object. Allowed values are "native", "regular" and "untagged". Default value is "regular".`,
				},
				resource.Attribute{
					Name:        "mtu",
					Description: `(Optional) Administrative MTU port on the aggregated interface of the L3out floating SVI object. Range of allowed values is "576" to "9216". Default value is "inherit".`,
				},
				resource.Attribute{
					Name:        "target_dscp",
					Description: `(Optional) Target DSCP of the L3out floating SVI object. Allowed values are "AF11", "AF12", "AF13", "AF21", "AF22", "AF23", "AF31", "AF32", "AF33", "AF41", "AF42", "AF43", "CS0", "CS1", "CS2", "CS3", "CS4", "CS5", "CS6", "CS7", "EF", "VA" and "unspecified". Default value is "unspecified".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) A configuration option that allows virtual machines to send frames with a mac address that is different from the one specified in the virtual-nic adapter configuration. Allowed values are "Disabled" and "Enabled". Default value is "Disabled".`,
				},
				resource.Attribute{
					Name:        "mac_change",
					Description: `(Optional) The status of the mac address change support of the port groups in an external VMM controller, such as a vCenter. Allowed values are "Disabled" and "Enabled". Default value is "Disabled".`,
				},
				resource.Attribute{
					Name:        "promiscuous_mode",
					Description: `(Optional) The status of promiscuous mode support status of the port groups in an external VMM controller, such as a vCenter. This needs to be turned on only for service devices in the cloud, not for Enterprise AVE service deployments. Allowed values are "Disabled" and "Enabled". Default value is "Disabled".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "encap",
					Description: `(Optional) Access port encapsulation (VLAN) of the target (format: vlan-101). This feature can only be used when the Floating SVI is associated to a physical domain (tdn points to infraDomP). ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the L3out Floating SVI. ## Importing An existing L3out Floating SVI can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l3out_floating_svi.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI L4-L7 Device`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the L4-L7 Device.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "domain_dn",
					Description: `(Required) Distinguished name of the VMM Domain in which the VM is deployed. Type: String.`,
				},
				resource.Attribute{
					Name:        "switching_mode",
				...
				resource.Attribute{
					...
					Description: `(Optional) Represents a relation from L4-L7 Device to a Physical Domain Profile (class physDomP). Type: String. ## Importing ## An existing L4-L7 Device can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l4-l7_device.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI L4-L7 Logical Interface`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "l4_l7_device_dn",
					Description: `(Required) Distinguished name of the parent L4-L7 Device object.`,
				},
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Logical Interface object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					...
					Description: `(Optional) Represents the relation between a set of Concrete Interfaces and the Device Cluster (class vnsCIf). Type: List. ## Importing ## An existing L4-L7 Logical Interface can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l4_l7_logical_interface.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI L4-L7 Redirect Health Group`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the L4-L7 Redirect Health Group object.`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "description",
					Description: `(Optional) Description of the L4-L7 Redirect Health Group object. ## Importing ## An existing L4-L7 Redirect Health Group can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_l4_l7_redirect_health_group.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Access Policies",
			ShortDescription: `Manages ACI LACP Member Policy`,
			Description:      ``,
			Keywords: []string{
				"access",
				"policies",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "transmit_rate",
					Description: `(Optional) Transmission Rate. The configured transmit rate of the LACP packets. ## Importing ## An existing LACPMemberPolicy can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_lacp_member_policy.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Access Policies",
			ShortDescription: `Manages ACI Override Policy Group`,
			Description:      ``,
			Keywords: []string{
				"access",
				"policies",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the Override Policy Group object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "port_channel_member",
					Description: `(Optional) Represents the relation to a Relation to LACP Interface Policy (class lacpIfPol). The PortChannel member policy configured parameters. Type: String. ## Importing ## An existing infraAccBndlSubgrp can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_leaf_access_bundle_policy_sub_group.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Access Policies",
			ShortDescription: `Manages the ACI Multicast Address Pool`,
			Description:      ``,
			Keywords: []string{
				"access",
				"policies",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "id",
					Description: `Attribute id set to the Dn of the Multicast Address Pool. ## Importing ## An existing MulticastAddressPool can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_multicast_pool.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "Access Policies",
			ShortDescription: `Manages the ACI Multicast Address Pool Block`,
			Description:      ``,
			Keywords: []string{
				"access",
				"policies",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "id",
					Description: `Attribute id set to the Dn of the Multicast Address Pool Block. ## Importing ## An existing MulticastAddressBlock can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_multicast_pool_block.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI Destination of L1/L2 Redirected Traffic`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Required) Destination Name of the destination of the L1/L2 Redirected Traffic.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "pod_id",
					Description: `(Optional) Pod Id of the destination of the L1/L2 Redirected Traffic. Allowed range is 1-255 and default value is "1".`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) Represents the relation to a Concrete Interface (class vnsCIf). ## Importing ## An existing Destination of the L1/L2 Redirected Traffic can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_pbr_l1_l2_destination.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "L4-L7 Services",
			ShortDescription: `Manages ACI PBR Backup Policy`,
			Description:      ``,
			Keywords: []string{
				"l4",
				"l7",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "name",
					Description: `(Required) Name of the PBR Backup Policy object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) Name Alias of the PBR Backup Policy object. ## Importing ## An existing PBR Backup Policy can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_service_redirect_backup_policy.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Cloud",
			ShortDescription: `Manages ACI Tenant to Cloud Account association`,
			Description:      ``,
			Keywords: []string{
				"cloud",
				"tenant",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					...
					Description: `(Optional) The distinguished name of the target Cloud Account object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) Name Alias of the Tenant to Cloud Account association object. ## Importing ## An existing Tenant to Cloud Account can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_tenant_to_cloud_account.example "<Dn>" ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Category:         "Networking",
			ShortDescription: `Manages ACI Inter-VRF Leaked EPG/BD Subnet`,
			Description:      ``,
			Keywords: []string{
				"networking",
				"vrf",
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "ip",
					Description: `(Required) IP of the Inter-VRF Leaked EPG/BD Subnet object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					...
					Description: `(Optional) Visibility of the Inter-VRF Leaked EPG/BD Subnet object. Allowed values are "true", "false" and default value is "false". Type: String.`,
				},
				resource.Attribute{
					Name:        "leak_to",
				...
				resource.Attribute{
					Name:        "vrf_dn",
					Description: `(Required) Distinguished name of the destination VRF object, which is mapped to the ` + "`" + `Tenant and VRF Destinations` + "`" + ` object.`,
				},
				resource.Attribute{
					Name:        "allow_l3out_advertisement",
					Description: `(Optional) Scope of the destination VRF object, which is mapped to the ` + "`" + `Tenant and VRF Destinations` + "`" + ` object. Allowed values are "inherit", "true", "false" and default value is "inherit". For Cloud APIC allow_l3out_advertisement must be set as true. Type: String. ## Importing ## An existing Inter-VRFLeakedEPG/BDSubnet can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_vrf_leak_epg_bd_subnet.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
	...
	resourcesMap = map[string]int{
		...
		"aci_bulk_epg_to_static_path":                  27,
		"aci_cdp_interface_policy":                     28,
		"aci_cloud_account":                            29,
		"aci_cloud_ad":                                 30,
		"aci_cloud_applicationcontainer":               31,
		"aci_cloud_aws_provider":                       32,
		"aci_cloud_cidr_pool":                          33,
		"aci_cloud_context_profile":                    34,
		"aci_cloud_credentials":                        35,
		"aci_cloud_domain_profile":                     36,
		"aci_cloud_endpoint_selector":                  37,
		"aci_cloud_endpoint_selectorfor_external_epgs": 38,
		"aci_cloud_epg":                                39,
		"aci_cloud_external_epg":                       40,
		"aci_cloud_external_network":                   41,
		"aci_cloud_ipsec_tunnel_subnet_pool":           42,
		"aci_cloud_provider_profile":                   43,
		"aci_cloud_subnet":                             44,
		"aci_cloud_vpn_gateway":                        45,
		"aci_cloud_vpn_network":                        46,
		"aci_cloud_vrf_leak_routes":                    47,
		"aci_concrete_device":                          48,
		"aci_concrete_interface":                       49,
		"aci_configuration_export_policy":              50,
		"aci_configuration_import_policy":              51,
		"aci_connection":                               52,
		"aci_console_authentication":                   53,
		"aci_contract":                                 54,
		"aci_contract_subject":                         55,
		"aci_contract_subject_filter":                  56,
		"aci_contract_subject_one_way_filter":          57,
		"aci_coop_policy":                              58,
		"aci_default_authentication":                   59,
		"aci_destination_of_redirected_traffic":        60,
		"aci_dhcp_option_policy":                       61,
		"aci_dhcp_relay_policy":                        62,
		"aci_duo_provider_group":                       63,
		"aci_encryption_key":                           64,
		"aci_end_point_retention_policy":               65,
		"aci_endpoint_controls":                        66,
		"aci_endpoint_ip_aging_profile":                67,
		"aci_endpoint_loop_protection":                 68,
		"aci_endpoint_security_group":                  69,
		"aci_endpoint_security_group_epg_selector":     70,
		"aci_endpoint_security_group_selector":         71,
		"aci_endpoint_security_group_tag_selector":     72,
		"aci_epg_to_contract":                          73,
		"aci_epg_to_contract_interface":                74,
		"aci_epg_to_domain":                            75,
		"aci_epg_to_static_path":                       76,
		"aci_epgs_using_function":                      77,
		"aci_error_disable_recovery":                   78,
		"aci_external_network_instance_profile":        79,
		"aci_fabric_if_pol":                            80,
		"aci_fabric_node_control":                      81,
		"aci_fabric_node_member":                       82,
		"aci_fabric_wide_settings":                     83,
		"aci_fc_domain":                                84,
		"aci_fex_bundle_group":                         85,
		"aci_fex_profile":                              86,
		"aci_file_remote_path":                         87,
		"aci_filter":                                   88,
		"aci_filter_entry":                             89,
		"aci_firmware_download_task":                   90,
		"aci_firmware_group":                           91,
		"aci_firmware_policy":                          92,
		"aci_function_node":                            93,
		"aci_global_security":                          94,
		"aci_hsrp_group_policy":                        95,
		"aci_hsrp_interface_policy":                    96,
		"aci_imported_contract":                        97,
		"aci_interface_blacklist":                      98,
		"aci_interface_config":                         99,
		"aci_interface_fc_policy":                      100,
		"aci_ip_sla_monitoring_policy":                 101,
		"aci_isis_domain_policy":                       102,
		"aci_l2_domain":                                103,
		"aci_l2_interface_policy":                      104,
		"aci_l2_outside":                               105,
		"aci_l2out_extepg":                             106,
		"aci_l3_domain_profile":                        107,
		"aci_l3_ext_subnet":                            108,
		"aci_l3_interface_policy":                      109,
		"aci_l3_outside":                               110,
		"aci_l3out_bfd_interface_profile":              111,
		"aci_l3out_bgp_external_policy":                112,
		"aci_l3out_bgp_protocol_profile":               113,
		"aci_l3out_floating_svi":                       114,
		"aci_l3out_hsrp_interface_group":               115,
		"aci_l3out_hsrp_interface_profile":             116,
		"aci_l3out_hsrp_secondary_vip":                 117,
		"aci_l3out_loopback_interface_profile":         118,
		"aci_l3out_ospf_external_policy":               119,
		"aci_l3out_ospf_interface_profile":             120,
		"aci_l3out_path_attachment":                    121,
		"aci_l3out_path_attachment_secondary_ip":       122,
		"aci_l3out_route_tag_policy":                   123,
		"aci_l3out_static_route":                       124,
		"aci_l3out_static_route_next_hop":              125,
		"aci_l3out_vpc_member":                         126,
		"aci_l4_l7_devices":                            127,
		"aci_l4_l7_logical_interface":                  128,
		"aci_l4_l7_redirect_health_group":              129,
		"aci_l4_l7_service_graph_template":             130,
		"aci_lacp_member_policy":                       131,
		"aci_lacp_policy":                              132,
		"aci_ldap_group_map":                           133,
		"aci_ldap_group_map_rule":                      134,
		"aci_ldap_group_map_rule_to_group_map":         135,
		"aci_ldap_provider":                            136,
		"aci_leaf_access_bundle_policy_group":          137,
		"aci_leaf_access_bundle_policy_sub_group":      138,
		"aci_leaf_access_port_policy_group":            139,
		"aci_leaf_breakout_port_group":                 140,
		"aci_leaf_interface_profile":                   141,
		"aci_leaf_profile":                             142,
		"aci_leaf_selector":                            143,
		"aci_lldp_interface_policy":                    144,
		"aci_local_user":                               145,
		"aci_logical_device_context":                   146,
		"aci_logical_interface_context":                147,
		"aci_logical_interface_profile":                148,
		"aci_logical_node_profile":                     149,
		"aci_logical_node_to_fabric_node":              150,
		"aci_login_domain":                             151,
		"aci_login_domain_provider":                    152,
		"aci_maintenance_group_node":                   153,
		"aci_maintenance_policy":                       154,
		"aci_managed_node_connectivity_group":          155,
		"aci_match_community_terms":                    156,
		"aci_match_regex_community_terms":              157,
		"aci_match_route_destination_rule":             158,
		"aci_match_rule":                               159,
		"aci_mcp_instance_policy":                      160,
		"aci_mgmt_preference":                          161,
		"aci_mgmt_zone":                                162,
		"aci_miscabling_protocol_interface_policy":     163,
		"aci_monitoring_policy":                        164,
		"aci_multicast_pool":                           165,
		"aci_multicast_pool_block":                     166,
		"aci_node_block":                               167,
		"aci_node_block_firmware":                      168,
		"aci_node_mgmt_epg":                            169,
		"aci_ospf_interface_policy":                    170,
		"aci_ospf_route_summarization":                 171,
		"aci_ospf_timers":                              172,
		"aci_pbr_l1_l2_destination":                    173,
		"aci_physical_domain":                          174,
		"aci_pod_maintenance_group":                    175,
		"aci_port_security_policy":                     176,
		"aci_port_tracking":                            177,
		"aci_qos_instance_policy":                      178,
		"aci_radius_provider":                          179,
		"aci_radius_provider_group":                    180,
		"aci_ranges":                                   181,
		"aci_recurring_window":                         182,
		"aci_rest":                                     183,
		"aci_rest_managed":                             184,
		"aci_route_control_context":                    185,
		"aci_route_control_profile":                    186,
		"aci_rsa_provider":                             187,
		"aci_saml_provider":                            188,
		"aci_saml_provider_group":                      189,
		"aci_service_redirect_backup_policy":           190,
		"aci_service_redirect_policy":                  191,
		"aci_snmp_community":                           192,
		"aci_span_destination_group":                   193,
		"aci_span_source_group":                        194,
		"aci_span_sourcedestination_group_match_label": 195,
		"aci_spanning_tree_interface_policy":           196,
		"aci_spine_access_port_selector":               197,
		"aci_spine_interface_profile":                  198,
		"aci_spine_interface_profile_selector":         199,
		"aci_spine_port_policy_group":                  200,
		"aci_spine_port_selector":                      201,
		"aci_spine_profile":                            202,
		"aci_spine_switch_association":                 203,
		"aci_spine_switch_policy_group":                204,
		"aci_static_node_mgmt_address":                 205,
		"aci_subnet":                                   206,
		"aci_taboo_contract":                           207,
		"aci_tacacs_accounting":                        208,
		"aci_tacacs_accounting_destination":            209,
		"aci_tacacs_provider":                          210,
		"aci_tacacs_provider_group":                    211,
		"aci_tacacs_source":                            212,
		"aci_tag":                                      213,
		"aci_tenant":                                   214,
		"aci_tenant_to_cloud_account":                  215,
		"aci_trigger_scheduler":                        216,
		"aci_user_security_domain":                     217,
		"aci_user_security_domain_role":                218,
		"aci_vlan_encapsulationfor_vxlan_traffic":      219,
		"aci_vlan_pool":                                220,
		"aci_vmm_controller":                           221,
		"aci_vmm_credential":                           222,
		"aci_vmm_domain":                               223,
		"aci_vpc_domain_policy":                        224,
		"aci_vpc_explicit_protection_group":            225,
		"aci_vrf":                                      226,
		"aci_vrf_leak_epg_bd_subnet":                   227,
		"aci_vrf_snmp_context":                         228,
		"aci_vrf_snmp_context_community":               229,
		"aci_vrf_to_bgp_address_family_context":        230,
		"aci_vsan_pool":                                231,
		"aci_vswitch_policy":                           232,
		"aci_vxlan_pool":                               233,
		"aci_x509_certificate":                         234,
	}
)
