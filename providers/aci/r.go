...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "admin_st",
					Description: `(Optional) administrative state Allowed values: "enabled", "disabled"`,
				},
				resource.Attribute{
					Name:        "annotation",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "admin_st",
					Description: `(Optional) admin state of the export policy Allowed values: "untriggered", "triggered"`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "format",
					Description: `(Optional) export data format Allowed values: "xml", "json"`,
				},
				resource.Attribute{
					Name:        "include_secure_fields",
					Description: `(Optional) include_secure_fields for object configuration_export_policy. Allowed values: "no", "yes"`,
				},
				resource.Attribute{
				...
				resource.Attribute{
					Name:        "snapshot",
					Description: `(Optional) snapshot for object configuration_export_policy. Allowed values: "no", "yes"`,
				},
				resource.Attribute{
					Name:        "target_dn",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "admin_st",
					Description: `(Optional) admin state of the import Allowed values: "untriggered", "triggered"`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					...
					Description: `(Optional) fail_on_decrypt_errors for object configuration_import_policy. Allowed values: "no", "yes"`,
				},
				resource.Attribute{
					Name:        "file_name",
				...
				resource.Attribute{
					Name:        "import_mode",
					Description: `(Optional) data import mode. Allowed values: "atomic", "best-effort"`,
				},
				resource.Attribute{
					Name:        "import_type",
					Description: `(Optional) data import type. Allowed values: "merge", "replace"`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "snapshot",
					Description: `(Optional) snapshot for object configuration_import_policy. Allowed values: "no", "yes"`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "conn_dir",
					Description: `(Optional) conn_dir for object connection. Allowed values are "consumer", "provider". Default value is "provider".`,
				},
				resource.Attribute{
					Name:        "conn_type",
				...
				resource.Attribute{
					Name:        "direct_connect",
					Description: `(Optional) direct_connect for object connection. Allowed values are "yes" and "no". Default value is "no".`,
				},
				resource.Attribute{
					Name:        "name_alias",
					Description: `(Optional) name_alias for object connection.`,
				},
				resource.Attribute{
					Name:        "unicast_route",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				resource.Attribute{
					Name:        "name",
					Description: `(Required) name of leaf breakout port group object.`,
				},
				resource.Attribute{
					Name:        "annotation",
				...
				resource.Attribute{
					Name:        "brkout_map",
					Description: `(Optional) breakout map for leaf breakout port group object. Allowed values are "100g-2x", "100g-4x", "10g-4x", "25g-4x", "50g-8x" and "none". Default value is "none".`,
				},
				resource.Attribute{
					Name:        "name_alias",
				...
				resource.Attribute{
					Name:        "relation_infra_rs_mon_brkout_infra_pol",
					Description: `(Optional) relation to class monInfraPol. Cardinality - N_TO_ONE. Type - String. ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the Leaf Breakout Port Group. ## Importing ## An existing Leaf Breakout Port Group can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_leaf_breakout_port_group.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "fwtype",
					Description: `(Optional) fwtype for object pod_maintenance_group. Allowed values: "controller", "switch", "catalog", "plugin","pluginPackage", "config", "vpod"`,
				},
				resource.Attribute{
					Name:        "name_alias",
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "role",
					Description: `(Optional) system role type. Allowed values: "external", "internal" ## Attribute Reference The only attribute that this resource exports is the ` + "`" + `id` + "`" + `, which is set to the Dn of the Ranges. ## Importing ## An existing Ranges can be [imported][docs-import] into this resource via its Dn, via the following command: [docs-import]: https://www.terraform.io/docs/import/index.html ` + "`" + `` + "`" + `` + "`" + ` terraform import aci_ranges.example <Dn> ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "alloc_mode",
					Description: `(Optional) allocation mode. Allowed values: "dynamic", "static"`,
				},
				resource.Attribute{
					Name:        "annotation",
	...
	resourcesMap = map[string]int{
		...
		"aci_cloud_applicationcontainer":               15,
		"aci_cloud_availability_zone":                  16,
		"aci_cloud_aws_provider":                       17,
		"aci_cloud_cidr_pool":                          18,
		"aci_cloud_context_profile":                    19,
		"aci_cloud_domain_profile":                     20,
		"aci_cloud_endpoint_selector":                  21,
		"aci_cloud_endpoint_selectorfor_external_epgs": 22,
		"aci_cloud_epg":                                23,
		"aci_cloud_external_epg":                       24,
		"aci_cloud_provider_profile":                   25,
		"aci_cloud_providers_region":                   26,
		"aci_cloud_subnet":                             27,
		"aci_cloud_vpn_gateway":                        28,
		"aci_configuration_export_policy":              29,
		"aci_configuration_import_policy":              30,
		"aci_connection":                               31,
		"aci_contract":                                 32,
		"aci_contract_subject":                         33,
		"aci_destination_of_redirected_traffic":        34,
		"aci_dhcp_option_policy":                       35,
		"aci_dhcp_relay_policy":                        36,
		"aci_end_point_retention_policy":               37,
		"aci_epg_to_contract":                          38,
		"aci_epg_to_domain":                            39,
		"aci_epg_to_static_path":                       40,
		"aci_epgs_using_function":                      41,
		"aci_external_network_instance_profile":        42,
		"aci_fabric_if_pol":                            43,
		"aci_fabric_node_member":                       44,
		"aci_fc_domain":                                45,
		"aci_fex_bundle_group":                         46,
		"aci_fex_profile":                              47,
		"aci_filter":                                   48,
		"aci_filter_entry":                             49,
		"aci_firmware_download_task":                   50,
		"aci_firmware_group":                           51,
		"aci_firmware_policy":                          52,
		"aci_function_node":                            53,
		"aci_imported_contract":                        54,
		"aci_interface_fc_policy":                      55,
		"aci_l2_domain":                                56,
		"aci_l2_interface_policy":                      57,
		"aci_l2_outside":                               58,
		"aci_l2out_extepg":                             59,
		"aci_l3_domain_profile":                        60,
		"aci_l3_ext_subnet":                            61,
		"aci_l3_outside":                               62,
		"aci_l4_l7_service_graph_template":             63,
		"aci_lacp_policy":                              64,
		"aci_leaf_access_bundle_policy_group":          65,
		"aci_leaf_access_port_policy_group":            66,
		"aci_leaf_breakout_port_group":                 67,
		"aci_leaf_interface_profile":                   68,
		"aci_leaf_profile":                             69,
		"aci_leaf_selector":                            70,
		"aci_lldp_interface_policy":                    71,
		"aci_local_user":                               72,
		"aci_logical_device_context":                   73,
		"aci_logical_interface_context":                74,
		"aci_logical_interface_profile":                75,
		"aci_logical_node_profile":                     76,
		"aci_logical_node_to_fabric_node":              77,
		"aci_maintenance_policy":                       78,
		"aci_miscabling_protocol_interface_policy":     79,
		"aci_monitoring_policy":                        80,
		"aci_node_block":                               81,
		"aci_node_block_firmware":                      82,
		"aci_node_mgmt_epg":                            83,
		"aci_ospf_interface_policy":                    84,
		"aci_physical_domain":                          85,
		"aci_pod_maintenance_group":                    86,
		"aci_port_security_policy":                     87,
		"aci_ranges":                                   88,
		"aci_service_redirect_policy":                  89,
		"aci_span_destination_group":                   90,
		"aci_span_source_group":                        91,
		"aci_span_sourcedestination_group_match_label": 92,
		"aci_spine_interface_profile":                  93,
		"aci_spine_port_policy_group":                  94,
		"aci_spine_port_selector":                      95,
		"aci_spine_profile":                            96,
		"aci_spine_switch_association":                 97,
		"aci_subnet":                                   98,
		"aci_taboo_contract":                           99,
		"aci_tenant":                                   100,
		"aci_trigger_scheduler":                        101,
		"aci_vlan_encapsulationfor_vxlan_traffic":      102,
		"aci_vlan_pool":                                103,
		"aci_vmm_domain":                               104,
		"aci_vpc_explicit_protection_group":            105,
		"aci_vrf":                                      106,
		"aci_vsan_pool":                                107,
		"aci_vxlan_pool":                               108,
		"aci_x509_certificate":                         109,
	}
)
