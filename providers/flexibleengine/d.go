...
`,
	...
	dataSourcesMap = map[string]int{
		...
		"flexibleengine_csbs_backup_policy_v1":              10,
		"flexibleengine_csbs_backup_v1":                     11,
		"flexibleengine_cts_tracker_v1":                     12,
		"flexibleengine_dcs_az_v1":                          13,
		"flexibleengine_dcs_maintainwindow_v1":              14,
