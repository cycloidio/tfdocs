...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "type",
					Description: `(Optional) specifies the type of action triggered by an alarm. the value can be`,
				},
				resource.Attribute{
		...
		&resource.Resource{
			...
			Category:         "CSS Resources",
			ShortDescription: `CSS cluster snapshot management`,
			Description:      ``,
			Keywords: []string{
				"css",
				"snapshot",
		...
		&resource.Resource{
			...
			ShortDescription: `Manages a DNS PTR record in the FlexibleEngine DNS Service`,
			Description:      ``,
			Keywords: []string{
				"dns",
				"ptrrecord",
		...
		&resource.Resource{
			...
			Category:         "flexibleengine_network_acl",
			ShortDescription: `Manages a network ACL rule resource within FlexibleEngine.`,
			Description:      ``,
			Keywords: []string{
		...
		&resource.Resource{
			...
			Category:         "RDS Resources",
			ShortDescription: `RDS instance management`,
			Description:      ``,
			Icon:             "Database-RDS .svg",
			Keywords: []string{
				"rds",
		...
		&resource.Resource{
			...
			Category:         "RDS Resources",
			ShortDescription: `RDS read replica management`,
			Description:      ``,
			Keywords: []string{
				"rds",
				"read",
		...
		&resource.Resource{
			...
			ShortDescription: `Provides an access rule resource of Scalable File Resource (SFS).`,
			Description:      ``,
			Keywords: []string{
				"sfs",
				"access",
		...
		&resource.Resource{
			...
			Category:         "SFS Resources",
			ShortDescription: `Provides an Scalable File Resource (SFS) Turbo resource.`,
			Description:      ``,
			Keywords: []string{
				"sfs",
				"turbo",
		...
		&resource.Resource{
			...
			Category:         "VPC Endpoint Resources",
			ShortDescription: `Provides a resource to manage the VPC endpoint connections.`,
			Description:      ``,
			Keywords: []string{
				"vpc",
				"endpoint",
		...
		&resource.Resource{
			...
			Category:         "VPC Endpoint Resources",
			ShortDescription: `Provides a resource to manage a VPC endpoint resource.`,
			Description:      ``,
			Keywords: []string{
				"vpc",
				"endpoint",
		...
		&resource.Resource{
			...
			Category:         "VPC Endpoint Resources",
			ShortDescription: `Provides a resource to manage a VPC endpoint service resource.`,
			Description:      ``,
			Keywords: []string{
				"vpc",
				"endpoint",
	...
	resourcesMap = map[string]int{
		...
		"flexibleengine_ces_alarmrule":                      7,
		...
		"flexibleengine_css_snapshot_v1":                    19,
		"flexibleengine_cts_tracker_v1":                     20,
		"flexibleengine_dcs_instance_v1":                    21,
		"flexibleengine_dds_instance_v3":                    22,
		"flexibleengine_dns_ptrrecord_v2":                   23,
		"flexibleengine_dns_recordset_v2":                   24,
		"flexibleengine_dns_zone_v2":                        25,
		"flexibleengine_drs_replication_v2":                 26,
		"flexibleengine_drs_replicationconsistencygroup_v2": 27,
		"flexibleengine_dws_cluster_v1":                     28,
		"flexibleengine_elb_backend":                        29,
		"flexibleengine_elb_health":                         30,
		"flexibleengine_elb_listener":                       31,
		"flexibleengine_elb_loadbalancer":                   32,
		"flexibleengine_fw_firewall_group_v2":               33,
		"flexibleengine_fw_policy_v2":                       34,
		"flexibleengine_fw_rule_v2":                         35,
		"flexibleengine_identity_agency_v3":                 36,
		"flexibleengine_identity_group_membership_v3":       37,
		"flexibleengine_identity_group_v3":                  38,
		"flexibleengine_identity_role_assignment_v3":        39,
		"flexibleengine_identity_role_v3":                   40,
		"flexibleengine_identity_user_v3":                   41,
		"flexibleengine_images_image_v2":                    42,
		"flexibleengine_kms_key_v1":                         43,
		"flexibleengine_lb_certificate_v2":                  44,
		"flexibleengine_lb_l7policy_v2":                     45,
		"flexibleengine_lb_l7rule_v2":                       46,
		"flexibleengine_lb_listener_v2":                     47,
		"flexibleengine_lb_loadbalancer_v2":                 48,
		"flexibleengine_lb_member_v2":                       49,
		"flexibleengine_lb_monitor_v2":                      50,
		"flexibleengine_lb_pool_v2":                         51,
		"flexibleengine_lb_whitelist_v2":                    52,
		"flexibleengine_mls_instance_v1":                    53,
		"flexibleengine_mrs_cluster_v1":                     54,
		"flexibleengine_mrs_hybrid_cluster_v1":              55,
		"flexibleengine_mrs_job_v1":                         56,
		"flexibleengine_nat_dnat_rule_v2":                   57,
		"flexibleengine_nat_gateway_v2":                     58,
		"flexibleengine_nat_snat_rule_v2":                   59,
		"flexibleengine_network_acl_rule":                   60,
		"flexibleengine_networking_floatingip_associate_v2": 61,
		"flexibleengine_networking_floatingip_v2":           62,
		"flexibleengine_networking_network_v2":              63,
		"flexibleengine_networking_port_v2":                 64,
		"flexibleengine_networking_router_interface_v2":     65,
		"flexibleengine_networking_router_route_v2":         66,
		"flexibleengine_networking_router_v2":               67,
		"flexibleengine_networking_secgroup_rule_v2":        68,
		"flexibleengine_networking_secgroup_v2":             69,
		"flexibleengine_networking_subnet_v2":               70,
		"flexibleengine_networking_vip_associate_v2":        71,
		"flexibleengine_networking_vip_v2":                  72,
		"flexibleengine_obs_bucket":                         73,
		"flexibleengine_obs_bucket_object":                  74,
		"flexibleengine_rds_instance_v1":                    75,
		"flexibleengine_rds_instance_v3":                    76,
		"flexibleengine_rds_parametergroup_v3":              77,
		"flexibleengine_rds_read_replica_v3":                78,
		"flexibleengine_rts_software_config_v1":             79,
		"flexibleengine_resource_rts_stack_v1":              80,
		"flexibleengine_s3_bucket":                          81,
		"flexibleengine_s3_bucket_object":                   82,
		"flexibleengine_s3_bucket_policy":                   83,
		"flexibleengine_sdrs_drill_v1":                      84,
		"flexibleengine_sdrs_protectedinstance_v1":          85,
		"flexibleengine_sdrs_protectiongroup_v1":            86,
		"flexibleengine_sdrs_replication_attach_v1":         87,
		"flexibleengine_sdrs_replication_pair_v1":           88,
		"flexibleengine_sfs_access_rule_v2":                 89,
		"flexibleengine_sfs_file_system_v2":                 90,
		"flexibleengine_sfs_turbo":                          91,
		"flexibleengine_smn_subscription_v2":                92,
		"flexibleengine_smn_topic_v2":                       93,
		"flexibleengine-vbs-backup-policy-v2":               94,
		"flexibleengine-vbs-backup-v2":                      95,
		"flexibleengine_vpc_eip_v1":                         96,
		"flexibleengine_vpc_peering_connection_accepter_v2": 97,
		"flexibleengine_vpc_peering_connection_v2":          98,
		"flexibleengine_vpc_route_v2":                       99,
		"flexibleengine_vpc_subnet_v1":                      100,
		"flexibleengine_vpc_v1":                             101,
		"flexibleengine_vpcep_approval":                     102,
		"flexibleengine_vpcep_endpoint":                     103,
		"flexibleengine_vpcep_service":                      104,
	}
)
