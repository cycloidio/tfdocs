...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The azure_vnet_site allows CRUD of Azure Vnet Site resource on Volterra SaaS" ------------------------------------------------------------------------------------------- Resource volterra_azure_vnet_site ================================= The Azure Vnet Site allows CRUD of Azure Vnet Site resource on Volterra SaaS ~> **Note:** Please refer to [Azure Vnet Site API docs](https://volterra.io/docs/api/views-azure-vnet-site) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_azure_vnet_site" "example" { name = "acmecorp-web" namespace = "staging" azure_region = ["East US"] // One of the arguments from this list "azure_cred assisted" must be set assisted = true // One of the arguments from this list "logs_streaming_disabled log_receiver" must be set logs_streaming_disabled = true resource_group = ["my-resources"] // One of the arguments from this list "ingress_egress_gw voltstack_cluster ingress_gw" must be set ingress_gw { az_nodes { azure_az = "1" disk_size = "disk_size" local_subnet { // One of the arguments from this list "subnet_param subnet" must be set subnet_param { ipv4 = "10.1.2.0/24" ipv6 = "1234:568:abcd:9100::/64" } } } azure_certified_hw = "azure-byol-voltmesh" } vnet { // One of the arguments from this list "new_vnet existing_vnet" must be set existing_vnet { resource_group = "resource_group" vnet_name = "vnet_name" } } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The discovery allows CRUD of Discovery resource on Volterra SaaS" ------------------------------------------------------------------------------- Resource volterra_discovery =========================== The Discovery allows CRUD of Discovery resource on Volterra SaaS ~> **Note:** Please refer to [Discovery API docs](https://volterra.io/docs/api/discovery) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_discovery" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "discovery_k8s discovery_consul" must be set discovery_k8s { access_info { // One of the arguments from this list "kubeconfig_url connection_info in_cluster" must be set kubeconfig_url { blindfold_secret_info_internal { decryption_provider = "decryption_provider" location = "string:///U2VjcmV0SW5mb3JtYXRpb24=" store_provider = "store_provider" } secret_encoding_type = "secret_encoding_type" // One of the arguments from this list "vault_secret_info clear_secret_info wingman_secret_info blindfold_secret_info" must be set wingman_secret_info { name = "ChargeBack-API-Key" } } // One of the arguments from this list "isolated reachable" must be set reachable = true } publish_info { // One of the arguments from this list "disable publish publish_fqdns dns_delegation" must be set disable = true } } where { // One of the arguments from this list "virtual_network site virtual_site" must be set virtual_network { ref { name = "test1" namespace = "staging" tenant = "acmecorp" } } } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The fleet allows CRUD of Fleet resource on Volterra SaaS" ----------------------------------------------------------------------- Resource volterra_fleet ======================= The Fleet allows CRUD of Fleet resource on Volterra SaaS ~> **Note:** Please refer to [Fleet API docs](https://volterra.io/docs/api/fleet) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_fleet" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "no_bond_devices bond_device_list" must be set bond_device_list { bond_devices { devices = ["devices"] // One of the arguments from this list "lacp active_backup" must be set active_backup = true link_polling_interval = "1000" link_up_delay = "200" name = "bond0" } } // One of the arguments from this list "no_dc_cluster_group dc_cluster_group dc_cluster_group_inside" must be set dc_cluster_group_inside { name = "test1" namespace = "staging" tenant = "acmecorp" } fleet_label = ["sfo"] // One of the arguments from this list "disable_gpu enable_gpu" must be set disable_gpu = true // One of the arguments from this list "interface_list default_config device_list" must be set device_list { devices { // One of the arguments from this list "network_device" must be set network_device { interface { name = "test1" namespace = "staging" tenant = "acmecorp" } use = "use" } name = "name" owner = "owner" } } // One of the arguments from this list "logs_streaming_disabled log_receiver" must be set logs_streaming_disabled = true // One of the arguments from this list "default_storage_class storage_class_list" must be set default_storage_class = true // One of the arguments from this list "no_storage_device storage_device_list" must be set no_storage_device = true // One of the arguments from this list "no_storage_interfaces storage_interface_list" must be set no_storage_interfaces = true // One of the arguments from this list "no_storage_static_routes storage_static_routes" must be set no_storage_static_routes = true // One of the arguments from this list "allow_all_usb usb_policy deny_all_usb" must be set deny_all_usb = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The forward_proxy_policy allows CRUD of Forward Proxy Policy resource on Volterra SaaS" ----------------------------------------------------------------------------------------------------- Resource volterra_forward_proxy_policy ====================================== The Forward Proxy Policy allows CRUD of Forward Proxy Policy resource on Volterra SaaS ~> **Note:** Please refer to [Forward Proxy Policy API docs](https://volterra.io/docs/api/views-forward-proxy-policy) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_forward_proxy_policy" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "drp_http_connect any_proxy network_connector proxy_label_selector" must be set any_proxy = true // One of the arguments from this list "allow_all allow_list deny_list rule_list" must be set allow_list { // One of the arguments from this list "default_action_deny default_action_allow default_action_next_policy" must be set default_action_deny = true dest_list { port_ranges = "80,443,8080-8191,9080" prefixes = ["prefixes"] } http_list { // One of the arguments from this list "exact_value suffix_value regex_value" must be set exact_value = "abc.zyz.com" // One of the arguments from this list "path_exact_value path_prefix_value path_regex_value any_path" must be set path_regex_value = "/abc/([a-z]([-a-z0-9]*[a-z0-9])?)/xyz$'" } tls_list { // One of the arguments from this list "exact_value suffix_value regex_value" must be set exact_value = "abc.zyz.com" } } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The gcp_vpc_site allows CRUD of Gcp Vpc Site resource on Volterra SaaS" ------------------------------------------------------------------------------------- Resource volterra_gcp_vpc_site ============================== The Gcp Vpc Site allows CRUD of Gcp Vpc Site resource on Volterra SaaS ~> **Note:** Please refer to [Gcp Vpc Site API docs](https://volterra.io/docs/api/views-gcp-vpc-site) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_gcp_vpc_site" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "assisted cloud_credentials" must be set cloud_credentials { name = "test1" namespace = "staging" tenant = "acmecorp" } gcp_region = ["us-west1"] instance_type = ["n1-standard-4"] // One of the arguments from this list "logs_streaming_disabled log_receiver" must be set logs_streaming_disabled = true // One of the arguments from this list "ingress_egress_gw voltstack_cluster ingress_gw" must be set ingress_gw { gcp_certified_hw = "gcp-byol-voltmesh" gcp_zone_names = ["us-west1-a, us-west1-b, us-west1-c"] local_network { // One of the arguments from this list "new_network_autogenerate new_network existing_network" must be set existing_network { name = "network1" } } local_subnet { // One of the arguments from this list "new_subnet existing_subnet" must be set new_subnet { primary_ipv4 = "10.1.0.0/16" subnet_name = "subnet1-in-network1" } } node_number = "node_number" } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The http_loadbalancer allows CRUD of Http Loadbalancer resource on Volterra SaaS" ----------------------------------------------------------------------------------------------- Resource volterra_http_loadbalancer =================================== The Http Loadbalancer allows CRUD of Http Loadbalancer resource on Volterra SaaS ~> **Note:** Please refer to [Http Loadbalancer API docs](https://volterra.io/docs/api/views-http-loadbalancer) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_http_loadbalancer" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "do_not_advertise advertise_on_public_default_vip advertise_on_public advertise_custom" must be set do_not_advertise = true // One of the arguments from this list "no_challenge js_challenge captcha_challenge policy_based_challenge" must be set policy_based_challenge { // One of the arguments from this list "default_captcha_challenge_parameters captcha_challenge_parameters" must be set default_captcha_challenge_parameters = true // One of the arguments from this list "no_challenge always_enable_js_challenge always_enable_captcha_challenge" must be set no_challenge = true // One of the arguments from this list "default_js_challenge_parameters js_challenge_parameters" must be set default_js_challenge_parameters = true // One of the arguments from this list "default_mitigation_settings malicious_user_mitigation" must be set default_mitigation_settings = true rule_list { rules { metadata { description = "Virtual Host for acmecorp website" disable = true name = "acmecorp-web" } spec { arg_matchers { invert_matcher = true // One of the arguments from this list "check_present check_not_present item presence" must be set presence = true name = "name" } // One of the arguments from this list "asn_list asn_matcher any_asn" must be set asn_matcher { asn_sets { name = "test1" namespace = "staging" tenant = "acmecorp" } } body_matcher { exact_values = ["['new york', 'london', 'sydney', 'tokyo', 'cairo']"] regex_values = ["['^new .*$', 'san f.*', '.* del .*']"] transformers = ["transformers"] } // One of the arguments from this list "disable_challenge enable_javascript_challenge enable_captcha_challenge" must be set enable_javascript_challenge = true // One of the arguments from this list "any_client client_name client_selector client_name_matcher" must be set any_client = true cookie_matchers { invert_matcher = true // One of the arguments from this list "check_not_present item presence check_present" must be set presence = true name = "Session" } domain_matcher { exact_values = ["['new york', 'london', 'sydney', 'tokyo', 'cairo']"] regex_values = ["['^new .*$', 'san f.*', '.* del .*']"] } expiration_timestamp = "0001-01-01T00:00:00Z" headers { invert_matcher = true // One of the arguments from this list "item presence check_present check_not_present" must be set item { exact_values = ["['new york', 'london', 'sydney', 'tokyo', 'cairo']"] regex_values = ["['^new .*$', 'san f.*', '.* del .*']"] transformers = ["transformers"] } name = "Accept-Encoding" } http_method { invert_matcher = true methods = ["['GET', 'POST', 'DELETE']"] } // One of the arguments from this list "any_ip ip_prefix_list ip_matcher" must be set any_ip = true path { exact_values = ["['/api/web/namespaces/project179/users/user1', '/api/config/namespaces/accounting/bgps', '/api/data/namespaces/project443/virtual_host_101']"] prefix_values = ["['/api/web/namespaces/project179/users/', '/api/config/namespaces/', '/api/data/namespaces/']"] regex_values = ["['^/api/web/namespaces/abc/users/([a-z]([-a-z0-9]*[a-z0-9])?)$', '/api/data/namespaces/proj404/virtual_hosts/([a-z]([-a-z0-9]*[a-z0-9])?)$']"] transformers = ["transformers"] } query_params { invert_matcher = true key = "sourceid" // One of the arguments from this list "item presence check_present check_not_present" must be set presence = true } tls_fingerprint_matcher { classes = ["classes"] exact_values = ["['ed6dfd54b01ebe31b7a65b88abfa7297', '16efcf0e00504ddfedde13bfea997952', 'de364c46b0dfc283b5e38c79ceae3f8f']"] excluded_values = ["['fb00055a1196aeea8d1bc609885ba953', 'b386946a5a44d1ddcc843bc75336dfce']"] } } } } // One of the arguments from this list "default_temporary_blocking_parameters temporary_user_blocking" must be set temporary_user_blocking { custom_page = "string:///PHA+IFBsZWFzZSBXYWl0IDwvcD4=" } } domains = ["www.foo.com"] // One of the arguments from this list "round_robin least_active random source_ip_stickiness cookie_stickiness ring_hash" must be set cookie_stickiness { name = "userid" path = "/Users/userid/browser/cookies" ttl = "ttl" } // One of the arguments from this list "https_auto_cert https http" must be set http { dns_volterra_managed = true } // One of the arguments from this list "disable_rate_limit rate_limit" must be set disable_rate_limit = true // One of the arguments from this list "no_service_policies active_service_policies service_policies_from_namespace" must be set service_policies_from_namespace = true // One of the arguments from this list "waf waf_rule disable_waf" must be set waf_rule { name = "test1" namespace = "staging" tenant = "acmecorp" } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The network_firewall allows CRUD of Network Firewall resource on Volterra SaaS" --------------------------------------------------------------------------------------------- Resource volterra_network_firewall ================================== The Network Firewall allows CRUD of Network Firewall resource on Volterra SaaS ~> **Note:** Please refer to [Network Firewall API docs](https://volterra.io/docs/api/network-firewall) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_network_firewall" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "fast_acl_set disable_fast_acl active_fast_acls" must be set disable_fast_acl = true // One of the arguments from this list "disable_forward_proxy_policy active_forward_proxy_policies forward_proxy_policy_set" must be set disable_forward_proxy_policy = true // One of the arguments from this list "network_policy_set disable_network_policy active_network_policies" must be set disable_network_policy = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The service_policy_rule allows CRUD of Service Policy Rule resource on Volterra SaaS" --------------------------------------------------------------------------------------------------- Resource volterra_service_policy_rule ===================================== The Service Policy Rule allows CRUD of Service Policy Rule resource on Volterra SaaS ~> **Note:** Please refer to [Service Policy Rule API docs](https://volterra.io/docs/api/service-policy-rule) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_service_policy_rule" "example" { name = "acmecorp-web" namespace = "staging" action = ["action"] // One of the arguments from this list "asn_matcher any_asn asn_list" must be set any_asn = true challenge_action = ["challenge_action"] // One of the arguments from this list "any_client client_name client_selector client_name_matcher" must be set any_client = true // One of the arguments from this list "any_ip ip_prefix_list ip_matcher" must be set any_ip = true waf_action { // One of the arguments from this list "none waf_skip_processing waf_rule_control waf_inline_rule_control waf_in_monitoring_mode" must be set none = true } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The tunnel allows CRUD of Tunnel resource on Volterra SaaS" ------------------------------------------------------------------------- Resource volterra_tunnel ======================== The Tunnel allows CRUD of Tunnel resource on Volterra SaaS ~> **Note:** Please refer to [Tunnel API docs](https://volterra.io/docs/api/tunnel) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_tunnel" "example" { name = "acmecorp-web" namespace = "staging" local_ip { // One of the arguments from this list "intf ip_address" must be set ip_address { // One of the arguments from this list "ip_address auto" must be set ip_address { // One of the arguments from this list "ipv4 ipv6" must be set ipv4 { addr = "192.168.1.1" } } virtual_network_type { // One of the arguments from this list "public site_local site_local_inside" must be set site_local_inside = true } } } remote_ip { // One of the arguments from this list "endpoints ip" must be set ip { // One of the arguments from this list "ipv4 ipv6" must be set ipv4 { addr = "192.168.1.1" } } } tunnel_type = ["tunnel_type"] } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The user_identification allows CRUD of User Identification resource on Volterra SaaS" --------------------------------------------------------------------------------------------------- Resource volterra_user_identification ===================================== The User Identification allows CRUD of User Identification resource on Volterra SaaS ~> **Note:** Please refer to [User Identification API docs](https://volterra.io/docs/api/user-identification) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_user_identification" "example" { name = "acmecorp-web" namespace = "staging" rules { // One of the arguments from this list "query_param_key http_header_name cookie_name none client_asn client_ip" must be set http_header_name = "http_header_name" } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The virtual_host allows CRUD of Virtual Host resource on Volterra SaaS" ------------------------------------------------------------------------------------- Resource volterra_virtual_host ============================== The Virtual Host allows CRUD of Virtual Host resource on Volterra SaaS ~> **Note:** Please refer to [Virtual Host API docs](https://volterra.io/docs/api/virtual-host) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_virtual_host" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "js_challenge captcha_challenge no_challenge" must be set no_challenge = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The virtual_network allows CRUD of Virtual Network resource on Volterra SaaS" ------------------------------------------------------------------------------------------- Resource volterra_virtual_network ================================= The Virtual Network allows CRUD of Virtual Network resource on Volterra SaaS ~> **Note:** Please refer to [Virtual Network API docs](https://volterra.io/docs/api/virtual-network) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_virtual_network" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "global_network site_local_network site_local_inside_network legacy_type srv6_network" must be set srv6_network { access_network_rtargets { // One of the arguments from this list "asn2byte_rtarget ipv4_addr_rtarget asn4byte_rtarget" must be set asn2byte_rtarget { as_number = "as_number" value = "value" } } // One of the arguments from this list "interface_ip_vip anycast_vip fleet_vip" must be set interface_ip_vip = true enterprise_network_rtargets { // One of the arguments from this list "asn2byte_rtarget ipv4_addr_rtarget asn4byte_rtarget" must be set asn2byte_rtarget { as_number = "as_number" value = "value" } } export_rtargets { // One of the arguments from this list "asn2byte_rtarget ipv4_addr_rtarget asn4byte_rtarget" must be set asn2byte_rtarget { as_number = "as_number" value = "value" } } fleets { name = "test1" namespace = "staging" tenant = "acmecorp" } internet_rtargets { // One of the arguments from this list "asn2byte_rtarget ipv4_addr_rtarget asn4byte_rtarget" must be set asn2byte_rtarget { as_number = "as_number" value = "value" } } // One of the arguments from this list "no_namespace_network srv6_network_ns_params" must be set no_namespace_network = true remote_sid_stats_plen = "72" slice { name = "test1" namespace = "staging" tenant = "acmecorp" } // One of the arguments from this list "site_snat_pool fleet_snat_pool interface_ip_snat_pool" must be set interface_ip_snat_pool = true } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
	...
	resourcesMap = map[string]int{
		...
		"volterra_volterra_rate_limiter_policy":        45,
		"volterra_volterra_registration_approval":      46,
		"volterra_volterra_role":                       47,
		"volterra_volterra_route":                      48,
		"volterra_volterra_secret_policy":              49,
		"volterra_volterra_secret_policy_rule":         50,
		"volterra_volterra_service_policy":             51,
		"volterra_volterra_service_policy_rule":        52,
		"volterra_volterra_site_state":                 53,
		"volterra_volterra_tcp_loadbalancer":           54,
		"volterra_volterra_tf_params_action":           55,
		"volterra_volterra_tgw_vpc_ip_prefixes":        56,
		"volterra_volterra_tgw_vpn_tunnels":            57,
		"volterra_volterra_token":                      58,
		"volterra_volterra_tunnel":                     59,
		"volterra_volterra_usb_policy":                 60,
		"volterra_volterra_user":                       61,
		"volterra_volterra_user_identification":        62,
		"volterra_volterra_virtual_host":               63,
		"volterra_volterra_virtual_k8s":                64,
		"volterra_volterra_virtual_network":            65,
		"volterra_volterra_virtual_site":               66,
		"volterra_volterra_voltstack_site":             67,
		"volterra_volterra_waf":                        68,
		"volterra_volterra_waf_rule_list":              69,
		"volterra_volterra_waf_rules":                  70,
	}
)
