...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The azure_vnet_site allows CRUD of Azure Vnet Site resource on Volterra SaaS" ------------------------------------------------------------------------------------------- Resource volterra_azure_vnet_site ================================= The Azure Vnet Site allows CRUD of Azure Vnet Site resource on Volterra SaaS ~> **Note:** Please refer to [Azure Vnet Site API docs](https://volterra.io/docs/api/views-azure-vnet-site) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_azure_vnet_site" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "azure_cred assisted" must be set azure_cred { name = "test1" namespace = "staging" tenant = "acmecorp" } // One of the arguments from this list "logs_streaming_disabled log_receiver" must be set logs_streaming_disabled = true // One of the arguments from this list "azure_region alternate_region" must be set azure_region = "eastus" resource_group = ["my-resources"] // One of the arguments from this list "ingress_egress_gw voltstack_cluster ingress_gw_ar ingress_egress_gw_ar voltstack_cluster_ar ingress_gw" must be set ingress_egress_gw_ar { azure_certified_hw = "azure-byol-multi-nic-voltmesh" // One of the arguments from this list "no_forward_proxy active_forward_proxy_policies forward_proxy_allow_all" must be set no_forward_proxy = true // One of the arguments from this list "no_global_network global_network_list" must be set no_global_network = true // One of the arguments from this list "no_inside_static_routes inside_static_routes" must be set no_inside_static_routes = true // One of the arguments from this list "no_network_policy active_network_policies" must be set no_network_policy = true node { fault_domain = "1" inside_subnet { // One of the arguments from this list "subnet_param subnet" must be set subnet { // One of the arguments from this list "subnet_resource_grp vnet_resource_group" must be set subnet_resource_grp = "subnet_resource_grp" subnet_name = "MySubnet" } } node_number = "node_number" outside_subnet { // One of the arguments from this list "subnet subnet_param" must be set subnet_param { ipv4 = "10.1.2.0/24" ipv6 = "1234:568:abcd:9100::/64" } } update_domain = "1" } // One of the arguments from this list "no_outside_static_routes outside_static_routes" must be set no_outside_static_routes = true } vnet { // One of the arguments from this list "new_vnet existing_vnet" must be set new_vnet { // One of the arguments from this list "name autogenerate" must be set name = "name" primary_ipv4 = "10.1.0.0/16" } } // One of the arguments from this list "total_nodes no_worker_nodes nodes_per_az" must be set nodes_per_az = "2" } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The fleet allows CRUD of Fleet resource on Volterra SaaS" ----------------------------------------------------------------------- Resource volterra_fleet ======================= The Fleet allows CRUD of Fleet resource on Volterra SaaS ~> **Note:** Please refer to [Fleet API docs](https://volterra.io/docs/api/fleet) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_fleet" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "no_bond_devices bond_device_list" must be set no_bond_devices = true // One of the arguments from this list "no_dc_cluster_group dc_cluster_group dc_cluster_group_inside" must be set no_dc_cluster_group = true fleet_label = ["sfo"] // One of the arguments from this list "enable_gpu enable_vgpu disable_gpu" must be set enable_vgpu { feature_type = "feature_type" server_address = "gridlicense1.example.com" server_port = "server_port" } // One of the arguments from this list "interface_list default_config device_list" must be set default_config = true // One of the arguments from this list "logs_streaming_disabled log_receiver" must be set logs_streaming_disabled = true // One of the arguments from this list "default_storage_class storage_class_list" must be set storage_class_list { storage_classes { advanced_storage_parameters = { "key1" = "value1" } allow_volume_expansion = true default_storage_class = true description = "description" // One of the arguments from this list "netapp_trident pure_service_orchestrator openebs_enterprise custom_storage" must be set netapp_trident { selector = { "key1" = "value1" } storage_pools = "backend-name1:.*;backend-name2:storagePoolListName" } reclaim_policy = "Delete" storage_class_name = "premium" storage_device = "storage_device" } } // One of the arguments from this list "no_storage_device storage_device_list" must be set no_storage_device = true // One of the arguments from this list "no_storage_interfaces storage_interface_list" must be set no_storage_interfaces = true // One of the arguments from this list "no_storage_static_routes storage_static_routes" must be set no_storage_static_routes = true // One of the arguments from this list "deny_all_usb allow_all_usb usb_policy" must be set deny_all_usb = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The http_loadbalancer allows CRUD of Http Loadbalancer resource on Volterra SaaS" ----------------------------------------------------------------------------------------------- Resource volterra_http_loadbalancer =================================== The Http Loadbalancer allows CRUD of Http Loadbalancer resource on Volterra SaaS ~> **Note:** Please refer to [Http Loadbalancer API docs](https://volterra.io/docs/api/views-http-loadbalancer) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_http_loadbalancer" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "advertise_on_public advertise_custom do_not_advertise advertise_on_public_default_vip" must be set do_not_advertise = true // One of the arguments from this list "no_challenge js_challenge captcha_challenge policy_based_challenge" must be set js_challenge { cookie_expiry = "cookie_expiry" custom_page = "string:///PHA+IFBsZWFzZSBXYWl0IDwvcD4=" js_script_delay = "js_script_delay" } domains = ["www.foo.com"] // One of the arguments from this list "least_active random source_ip_stickiness cookie_stickiness ring_hash round_robin" must be set cookie_stickiness { name = "userid" path = "/Users/userid/browser/cookies" ttl = "ttl" } // One of the arguments from this list "https_auto_cert https http" must be set http { dns_volterra_managed = true } // One of the arguments from this list "disable_rate_limit rate_limit" must be set disable_rate_limit = true // One of the arguments from this list "active_service_policies service_policies_from_namespace no_service_policies" must be set service_policies_from_namespace = true // One of the arguments from this list "disable_waf waf waf_rule app_firewall" must be set waf { name = "test1" namespace = "staging" tenant = "acmecorp" } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The k8s_cluster allows CRUD of K8s Cluster resource on Volterra SaaS" ----------------------------------------------------------------------------------- Resource volterra_k8s_cluster ============================= The K8s Cluster allows CRUD of K8s Cluster resource on Volterra SaaS ~> **Note:** Please refer to [K8s Cluster API docs](https://volterra.io/docs/api/k8s-cluster) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_k8s_cluster" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "cluster_wide_app_list no_cluster_wide_apps" must be set no_cluster_wide_apps = true // One of the arguments from this list "use_custom_cluster_role_bindings use_default_cluster_role_bindings" must be set use_default_cluster_role_bindings = true // One of the arguments from this list "use_default_cluster_roles use_custom_cluster_role_list" must be set use_default_cluster_roles = true // One of the arguments from this list "no_global_access global_access_enable" must be set no_global_access = true // One of the arguments from this list "no_insecure_registries insecure_registry_list" must be set no_insecure_registries = true // One of the arguments from this list "no_local_access local_access_config" must be set local_access_config { local_domain = "example.com" // One of the arguments from this list "default_port port" must be set default_port = true } // One of the arguments from this list "use_default_psp use_custom_psp_list" must be set use_default_psp = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The k8s_cluster_role allows CRUD of K8s Cluster Role resource on Volterra SaaS" --------------------------------------------------------------------------------------------- Resource volterra_k8s_cluster_role ================================== The K8s Cluster Role allows CRUD of K8s Cluster Role resource on Volterra SaaS ~> **Note:** Please refer to [K8s Cluster Role API docs](https://volterra.io/docs/api/k8s-cluster-role) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_k8s_cluster_role" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "policy_rule_list k8s_cluster_role_selector yaml" must be set yaml = "yaml" } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The log_receiver allows CRUD of Log Receiver resource on Volterra SaaS" ------------------------------------------------------------------------------------- Resource volterra_log_receiver ============================== The Log Receiver allows CRUD of Log Receiver resource on Volterra SaaS ~> **Note:** Please refer to [Log Receiver API docs](https://volterra.io/docs/api/log-receiver) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_log_receiver" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "data_dog splunk syslog" must be set syslog { // One of the arguments from this list "syslog_rfc3164 syslog_rfc5424" must be set syslog_rfc5424 = "500" // One of the arguments from this list "udp_server tcp_server tls_server" must be set tls_server { // One of the arguments from this list "volterra_ca trusted_ca_url" must be set trusted_ca_url = "trusted_ca_url" // One of the arguments from this list "mtls_disabled mtls_enable" must be set mtls_disabled = true // One of the arguments from this list "default_syslog_tls_port default_https_port port" must be set port = "3000" server_name = "server.acme.com" } } // One of the arguments from this list "site_local log_receiver_sites" must be set site_local = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The network_connector allows CRUD of Network Connector resource on Volterra SaaS" ----------------------------------------------------------------------------------------------- Resource volterra_network_connector =================================== The Network Connector allows CRUD of Network Connector resource on Volterra SaaS ~> **Note:** Please refer to [Network Connector API docs](https://volterra.io/docs/api/network-connector) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_network_connector" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "slo_to_global_dr slo_to_global_snat sli_to_slo_snat sli_to_slo_dr sli_to_global_dr sli_to_global_snat" must be set slo_to_global_snat { global_vn { name = "test1" namespace = "staging" tenant = "acmecorp" } snat_config { // One of the arguments from this list "interface_ip snat_pool snat_pool_allocator" must be set snat_pool_allocator { name = "test1" namespace = "staging" tenant = "acmecorp" } // One of the arguments from this list "default_gw_snat dynamic_routing" must be set default_gw_snat = true } } // One of the arguments from this list "disable_forward_proxy enable_forward_proxy" must be set enable_forward_proxy { connection_timeout = "4000" max_connect_attempts = "max_connect_attempts" // One of the arguments from this list "no_interception tls_intercept" must be set no_interception = true white_listed_ports = ["white_listed_ports"] white_listed_prefixes = ["['10.2.1.0/24', '192.168.8.0/29', '10.7.64.160/27']"] } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The network_firewall allows CRUD of Network Firewall resource on Volterra SaaS" --------------------------------------------------------------------------------------------- Resource volterra_network_firewall ================================== The Network Firewall allows CRUD of Network Firewall resource on Volterra SaaS ~> **Note:** Please refer to [Network Firewall API docs](https://volterra.io/docs/api/network-firewall) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_network_firewall" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "active_fast_acls fast_acl_set disable_fast_acl" must be set fast_acl_set { name = "test1" namespace = "staging" tenant = "acmecorp" } // One of the arguments from this list "disable_forward_proxy_policy active_forward_proxy_policies forward_proxy_policy_set" must be set disable_forward_proxy_policy = true // One of the arguments from this list "disable_network_policy active_network_policies network_policy_set" must be set disable_network_policy = true } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The route allows CRUD of Route resource on Volterra SaaS" ----------------------------------------------------------------------- Resource volterra_route ======================= The Route allows CRUD of Route resource on Volterra SaaS ~> **Note:** Please refer to [Route API docs](https://volterra.io/docs/api/route) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_route" "example" { name = "acmecorp-web" namespace = "staging" routes { disable_custom_script = true disable_location_add = true match { headers { invert_match = true name = "Content-Type" // One of the arguments from this list "presence exact regex" must be set exact = "application/json" } http_method = "http_method" path { // One of the arguments from this list "regex prefix path" must be set prefix = "/register/" } query_params { key = "assignee_username" // One of the arguments from this list "exact regex" must be set regex = "regex" } } request_headers_to_add { append = true name = "name" value = "value" } request_headers_to_remove = ["host"] response_headers_to_add { append = true name = "name" value = "value" } response_headers_to_remove = ["host"] // One of the arguments from this list "route_destination route_redirect route_direct_response" must be set route_redirect { host_redirect = "one.ves.io" path_redirect = "/api/register" proto_redirect = "https" // One of the arguments from this list "retain_all_params remove_all_params strip_query_params all_params" must be set retain_all_params = true response_code = "response_code" } service_policy { disable = true } waf_type { // One of the arguments from this list "app_firewall waf waf_rules" must be set waf { waf { name = "test1" namespace = "staging" tenant = "acmecorp" } } } } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The user_identification allows CRUD of User Identification resource on Volterra SaaS" --------------------------------------------------------------------------------------------------- Resource volterra_user_identification ===================================== The User Identification allows CRUD of User Identification resource on Volterra SaaS ~> **Note:** Please refer to [User Identification API docs](https://volterra.io/docs/api/user-identification) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_user_identification" "example" { name = "acmecorp-web" namespace = "staging" rules { // One of the arguments from this list "http_header_name cookie_name none client_asn client_ip query_param_key" must be set client_ip = true } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `"The virtual_host allows CRUD of Virtual Host resource on Volterra SaaS" ------------------------------------------------------------------------------------- Resource volterra_virtual_host ============================== The Virtual Host allows CRUD of Virtual Host resource on Volterra SaaS ~> **Note:** Please refer to [Virtual Host API docs](https://volterra.io/docs/api/virtual-host) to learn more Example Usage ------------- ` + "`" + `` + "`" + `` + "`" + `hcl resource "volterra_virtual_host" "example" { name = "acmecorp-web" namespace = "staging" // One of the arguments from this list "captcha_challenge no_challenge js_challenge" must be set js_challenge { cookie_expiry = "cookie_expiry" custom_page = "string:///PHA+IFBsZWFzZSBXYWl0IDwvcD4=" js_script_delay = "js_script_delay" } } ` + "`" + `` + "`" + `` + "`" + ` Argument Reference ---------------`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
	...
	resourcesMap = map[string]int{
		...
		"volterra_volterra_app_setting":                7,
		"volterra_volterra_app_type":                   8,
		"volterra_volterra_aws_tgw_site":               9,
		"volterra_volterra_aws_vpc_site":               10,
		"volterra_volterra_azure_vnet_site":            11,
		"volterra_volterra_bgp":                        12,
		"volterra_volterra_bgp_asn_set":                13,
		"volterra_volterra_cloud_credentials":          14,
		"volterra_volterra_cluster":                    15,
		"volterra_volterra_container_registry":         16,
		"volterra_volterra_dc_cluster_group":           17,
		"volterra_volterra_discovery":                  18,
		"volterra_volterra_dns_domain":                 19,
		"volterra_volterra_endpoint":                   20,
		"volterra_volterra_fast_acl":                   21,
		"volterra_volterra_fast_acl_for_internet_vips": 22,
		"volterra_volterra_fast_acl_rule":              23,
		"volterra_volterra_fleet":                      24,
		"volterra_volterra_forward_proxy_policy":       25,
		"volterra_volterra_gcp_vpc_site":               26,
		"volterra_volterra_healthcheck":                27,
		"volterra_volterra_http_loadbalancer":          28,
		"volterra_volterra_ip_prefix_set":              29,
		"volterra_volterra_k8s_cluster":                30,
		"volterra_volterra_k8s_cluster_role":           31,
		"volterra_volterra_k8s_cluster_role_binding":   32,
		"volterra_volterra_k8s_pod_security_policy":    33,
		"volterra_volterra_log_receiver":               34,
		"volterra_volterra_malicious_user_mitigation":  35,
		"volterra_volterra_modify_site":                36,
		"volterra_volterra_namespace":                  37,
		"volterra_volterra_network_connector":          38,
		"volterra_volterra_network_firewall":           39,
		"volterra_volterra_network_interface":          40,
		"volterra_volterra_network_policy":             41,
		"volterra_volterra_network_policy_rule":        42,
		"volterra_volterra_network_policy_view":        43,
		"volterra_volterra_origin_pool":                44,
		"volterra_volterra_policer":                    45,
		"volterra_volterra_protocol_policer":           46,
		"volterra_volterra_public_ip":                  47,
		"volterra_volterra_rate_limiter":               48,
		"volterra_volterra_rate_limiter_policy":        49,
		"volterra_volterra_registration_approval":      50,
		"volterra_volterra_role":                       51,
		"volterra_volterra_route":                      52,
		"volterra_volterra_secret_policy":              53,
		"volterra_volterra_secret_policy_rule":         54,
		"volterra_volterra_service_policy":             55,
		"volterra_volterra_service_policy_rule":        56,
		"volterra_volterra_site_mesh_group":            57,
		"volterra_volterra_site_state":                 58,
		"volterra_volterra_tcp_loadbalancer":           59,
		"volterra_volterra_tf_params_action":           60,
		"volterra_volterra_tgw_vpc_ip_prefixes":        61,
		"volterra_volterra_tgw_vpn_tunnels":            62,
		"volterra_volterra_token":                      63,
		"volterra_volterra_usb_policy":                 64,
		"volterra_volterra_user":                       65,
		"volterra_volterra_user_identification":        66,
		"volterra_volterra_virtual_host":               67,
		"volterra_volterra_virtual_k8s":                68,
		"volterra_volterra_virtual_network":            69,
		"volterra_volterra_virtual_site":               70,
		"volterra_volterra_voltstack_site":             71,
		"volterra_volterra_waf":                        72,
		"volterra_volterra_waf_rule_list":              73,
		"volterra_volterra_waf_rules":                  74,
	}
)
