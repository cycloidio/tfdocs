...
var (
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Resources",
			ShortDescription: `FireHydrant environments are used to tag incidents with where they are occurring.`,
			Description:      ``,
			Keywords:         []string{},
	...
	resourcesMap = map[string]int{
		...
		"firehydrant_runbook":       2,
		"firehydrant_service":       3,
		"firehydrant_severity":      4,
		"firehydrant_team":          5,
	}
)
