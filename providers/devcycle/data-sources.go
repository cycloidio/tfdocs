...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			...
			ShortDescription: `DevCycle Environment Data Source. Read data from a given DevCycle Environment. R`,
			Description:      ``,
			Keywords:         []string{},
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Evaluated Variable data source. Each instance of this data source represents a single evaluated variable, under a single userdata context.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
