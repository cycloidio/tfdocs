...
var (
	...
	resourcesMap = map[string]int{
		...
		"azuredevops_repository_policy_file_path_pattern":    21,
		"azuredevops_resource_authorization":                 22,
		"azuredevops_serviceendpoint_artifactory":            23,
		"azuredevops_serviceendpoint_aws":                    24,
		"azuredevops_serviceendpoint_azuredevops":            25,
		"azuredevops_serviceendpoint_azurerm":                26,
		"azuredevops_serviceendpoint_bitbucket":              27,
		"azuredevops_serviceendpoint_dockerregistry":         28,
		"azuredevops_serviceendpoint_generic":                29,
		"azuredevops_serviceendpoint_generic_git":            30,
		"azuredevops_serviceendpoint_github":                 31,
		"azuredevops_serviceendpoint_github_enterprise":      32,
		"azuredevops_serviceendpoint_kubernetes":             33,
		"azuredevops_serviceendpoint_npm":                    34,
		"azuredevops_serviceendpoint_runpipeline":            35,
		"azuredevops_serviceendpoint_servicefabric":          36,
		"azuredevops_serviceendpoint_sonarqube":              37,
		"azuredevops_serviceendpoint_ssh":                    38,
		"azuredevops_user_entitlement":                       39,
		"azuredevops_variable_group":                         40,
		"azuredevops_workitemquery_permissions":              41,
	}
)
