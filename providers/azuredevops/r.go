...
var (
	...
	resourcesMap = map[string]int{
		...
		"azuredevops_branch_policy_comment_resolution": 4,
		"azuredevops_branch_policy_merge_types":        5,
		"azuredevops_branch_policy_min_reviewers":      6,
		"azuredevops_branch_policy_work_item_linking":  7,
		"azuredevops_build_definition":                 8,
		"azuredevops_build_definition_permissions":     9,
		"azuredevops_git_permissions":                  10,
		"azuredevops_git_repository":                   11,
		"azuredevops_group":                            12,
		"azuredevops_group_membership":                 13,
		"azuredevops_iteration_permissions":            14,
		"azuredevops_project":                          15,
		"azuredevops_project_features":                 16,
		"azuredevops_project_permissions":              17,
		"azuredevops_resource_authorization":           18,
		"azuredevops_serviceendpoint_artifactory":      19,
		"azuredevops_serviceendpoint_aws":              20,
		"azuredevops_serviceendpoint_azurerm":          21,
		"azuredevops_serviceendpoint_bitbucket":        22,
