...
var (
	...
	resourcesMap = map[string]int{
		...
		"datadog_integration_aws_tag_filter":           6,
		"datadog_integration_azure":                    7,
		"datadog_integration_gcp":                      8,
		"datadog_integration_pagerduty":                9,
		"datadog_integration_pagerduty_service_object": 10,
		"datadog_integration_slack_channel":            11,
		"datadog_logs_archive":                         12,
		"datadog_logs_archive_order":                   13,
		"datadog_logs_custom_pipeline":                 14,
		"datadog_logs_index":                           15,
		"datadog_logs_index_order":                     16,
		"datadog_logs_integration_pipeline":            17,
		"datadog_logs_metric":                          18,
		"datadog_logs_pipeline_order":                  19,
		"datadog_metric_metadata":                      20,
		"datadog_monitor":                              21,
		"datadog_role":                                 22,
		"datadog_screenboard":                          23,
		"datadog_security_monitoring_default_rule":     24,
		"datadog_security_monitoring_rule":             25,
		"datadog_service_level_objective":              26,
		"datadog_synthetics_global_variable":           27,
		"datadog_synthetics_private_location":          28,
		"datadog_synthetics_test":                      29,
		"datadog_timeboard":                            30,
		"datadog_user":                                 31,
	}
)
