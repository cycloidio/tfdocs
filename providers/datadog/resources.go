...
var (
	...
	resourcesMap = map[string]int{
		...
		"datadog_cloud_workload_security_agent_rule":   4,
		"datadog_dashboard":                            5,
		"datadog_dashboard_json":                       6,
		"datadog_dashboard_list":                       7,
		"datadog_downtime":                             8,
		"datadog_integration_aws":                      9,
		"datadog_integration_aws_lambda_arn":           10,
		"datadog_integration_aws_log_collection":       11,
		"datadog_integration_aws_tag_filter":           12,
		"datadog_integration_azure":                    13,
		"datadog_integration_gcp":                      14,
		"datadog_integration_pagerduty":                15,
		"datadog_integration_pagerduty_service_object": 16,
		"datadog_integration_slack_channel":            17,
		"datadog_logs_archive":                         18,
		"datadog_logs_archive_order":                   19,
		"datadog_logs_custom_pipeline":                 20,
		"datadog_logs_index":                           21,
		"datadog_logs_index_order":                     22,
		"datadog_logs_integration_pipeline":            23,
		"datadog_logs_metric":                          24,
		"datadog_logs_pipeline_order":                  25,
		"datadog_metric_metadata":                      26,
		"datadog_metric_tag_configuration":             27,
		"datadog_monitor":                              28,
		"datadog_monitor_json":                         29,
		"datadog_organization_settings":                30,
		"datadog_role":                                 31,
		"datadog_security_monitoring_default_rule":     32,
		"datadog_security_monitoring_filter":           33,
		"datadog_security_monitoring_rule":             34,
		"datadog_service_level_objective":              35,
		"datadog_slo_correction":                       36,
		"datadog_synthetics_global_variable":           37,
		"datadog_synthetics_private_location":          38,
		"datadog_synthetics_test":                      39,
		"datadog_user":                                 40,
		"datadog_webhook":                              41,
		"datadog_webhook_custom_variable":              42,
	}
)
