...
var (
	...
	resourcesMap = map[string]int{
		...
		"datadog_child_organization":                   2,
		"datadog_dashboard":                            3,
		"datadog_dashboard_json":                       4,
		"datadog_dashboard_list":                       5,
		"datadog_downtime":                             6,
		"datadog_integration_aws":                      7,
		"datadog_integration_aws_lambda_arn":           8,
		"datadog_integration_aws_log_collection":       9,
		"datadog_integration_aws_tag_filter":           10,
		"datadog_integration_azure":                    11,
		"datadog_integration_gcp":                      12,
		"datadog_integration_pagerduty":                13,
		"datadog_integration_pagerduty_service_object": 14,
		"datadog_integration_slack_channel":            15,
		"datadog_logs_archive":                         16,
		"datadog_logs_archive_order":                   17,
		"datadog_logs_custom_pipeline":                 18,
		"datadog_logs_index":                           19,
		"datadog_logs_index_order":                     20,
		"datadog_logs_integration_pipeline":            21,
		"datadog_logs_metric":                          22,
		"datadog_logs_pipeline_order":                  23,
		"datadog_metric_metadata":                      24,
		"datadog_metric_tag_configuration":             25,
		"datadog_monitor":                              26,
		"datadog_organization_settings":                27,
		"datadog_role":                                 28,
		"datadog_security_monitoring_default_rule":     29,
		"datadog_security_monitoring_filter":           30,
		"datadog_security_monitoring_rule":             31,
		"datadog_service_level_objective":              32,
		"datadog_slo_correction":                       33,
		"datadog_synthetics_global_variable":           34,
		"datadog_synthetics_private_location":          35,
		"datadog_synthetics_test":                      36,
		"datadog_user":                                 37,
	}
)
