...
var (
	DataSources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information about LaunchDarkly flag triggers.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
		...
		&resource.Resource{
			...
			Category:         "Data Sources",
			ShortDescription: `Get information about a LaunchDarkly team.`,
			Description:      ``,
			Keywords:         []string{},
			Arguments:        []resource.Attribute{},
			Attributes:       []resource.Attribute{},
	...
	dataSourcesMap = map[string]int{
		...
		"launchdarkly_team":                     8,
		"launchdarkly_team_member":              9,
		"launchdarkly_team_members":             10,
