...
`,
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "record_type",
					Description: `(Required) (String) Must be formatted as the well-known resource record type (A, AAAA, TXT, etc.) or the corresponding number for the type; between 1 and 65535.<br/> Below are the supported resource record types with the corresponding number:<br/> ` + "`" + `A (1)` + "`" + ` ` + "`" + `NS (2)` + "`" + ` ` + "`" + `CNAME (5)` + "`" + ` ` + "`" + `PTR (12)` + "`" + ` ` + "`" + `MX (15)` + "`" + ` ` + "`" + `TXT (16)` + "`" + ` ` + "`" + `AAAA (28)` + "`" + ` ` + "`" + `SRV (33)` + "`" + ` ` + "`" + `SSHFP (44)` + "`" + ` ` + "`" + `APEXALIAS (65282)` + "`" + ``,
				},
				resource.Attribute{
					Name:        "ttl",
					Description: `(Optional) (Integer) The time to live (in seconds) for the record. Must be a value between 0 and 2147483647, inclusive.`,
				...
				resource.Attribute{
					Name:        "record_data",
					Description: `(Required) (String List) The data for the record displayed as the BIND presentation format for the specified RRTYPE.<br/> Example : For a SRV record, the format of data is ["priority weight port target"] (["2 2 523 example.com."])<br/> Additionally for MX, CNAME, and PTR record types, the data value must be a FQDN, as it cannot be relative to the zone name.<br/> ## Import Records can be imported by combining their ` + "`" + `owner_name` + "`" + `, ` + "`" + `zone_name` + "`" + `, and ` + "`" + `record_type` + "`" + `, separated by a colon.<br/> Example : ` + "`" + `www.example.com.:example.com.:A (1)` + "`" + `. -> For import, the ` + "`" + `owner_name` + "`" + ` and ` + "`" + `zone_name` + "`" + ` must be a FQDN, and ` + "`" + `record_type` + "`" + ` should have the type as well as the corresponding number as shown in the example below. Example: ` + "`" + `` + "`" + `` + "`" + ` $ terraform import ultradns_record.example "www.example.com.:example.com.:A (1)" ` + "`" + `` + "`" + `` + "`" + ``,
				},
			},
			Attributes: []resource.Attribute{},
		},
