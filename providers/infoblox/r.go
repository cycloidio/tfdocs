	...
	Resources = []*resource.Resource{
		...
		&resource.Resource{
			...
			Arguments: []resource.Attribute{
				...
				resource.Attribute{
					Name:        "gateway",
					Description: `(Optional) give the IP you want to reserve for gateway, by default the first IP gets reserved for gateway`,
				},
				resource.Attribute{
					Name:        "allocate_prefix_len",
					Description: `(Optional) Set parameter value>0 to allocate next available network with prefix=value from network container defined by parent_cidr`,
				},
			},
			Attributes: []resource.Attribute{},
		},
