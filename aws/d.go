...
`,
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "result",
					Description: `A result of the lambda function invocation.`,
				},

				resource.Attribute{
					Name:        "result_map",
					Description: `This field is set only if result is a map of primitive types.`,
				},
			},
			Attributes: []resource.Argument{
...
`,
			...
			Arguments: []resource.Argument{
				...
				resource.Attribute{
					Name:        "service_name",
					Description: `(Optional) The AWS service name of the specific VPC Endpoint to retrieve. ## Attributes Reference All of the argument attributes are also exported as result attributes.`,
				},
				...
				resource.Attribute{
					Name:        "dns_entry",
					Description: `The DNS entries for the VPC Endpoint. Applicable for endpoints of type ` + "`" + `Interface` + "`" + `. DNS blocks are documented below. DNS blocks (for ` + "`" + `dns_entry` + "`" + `) support the following attributes:`,
				},
